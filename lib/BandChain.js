            ...
            switch (_context12.prev = _context12.next) {
              case 0:
                sourceList = [{
                  ...
                  id: 8,
                  exponent: 9,
                  symbols: ['BTG', 'BZRX', 'SRM', 'SNT', 'SOL', 'CKB', 'BNT', 'CRV', 'MANA', 'YFV', 'KAVA', 'MATIC', 'TRB', 'REP', 'FTM', 'TOMO', 'ONE', 'WNXM', 'PAXG', 'WAN', 'SUSD', 'RLC', 'OXT', 'RVN', 'FNX']
                }, {
                  id: 8,
                  exponent: 9,
                  symbols: ['RENBTC', 'WBTC', 'DIA', 'BTM', 'IOTX', 'FET', 'JST', 'MCO', 'KMD', 'BTS', 'QKC', 'YAMV2', 'XZC', 'UOS', 'AKRO', 'HNT', 'HOT', 'KAI', 'OGN', 'WRX', 'KDA', 'ORN', 'FOR', 'AST', 'STORJ']
                }, {
                  id: 8,
                  exponent: 9,
                  symbols: ['2KEY', 'ABYSS', 'BLZ', 'BTU', 'CND', 'CVC', 'DGX', 'ELF', 'EQUAD', 'EURS', 'FXC', 'GDC', 'GEN', 'GHT', 'GNO', 'GVT', 'IOST', 'KEY', 'LOOM', 'MET', 'MFG', 'MLN', 'MTL', 'MYB', 'NEXXO']
                }, {
                  id: 8,
                  exponent: 9,
                  symbols: ['NPXS', 'OST', 'PAY', 'PBTC', 'PLR', 'PLTC', 'PNK', 'PNT', 'POLY', 'POWR', 'QNT', 'RAE', 'REQ', 'RSV', 'SAN', 'SPIKE', 'SPN', 'STMX', 'TKN', 'TKX', 'TRYB', 'UBT', 'UPP', 'USDS', 'VIDT']
                }, {
                  id: 8,
                  exponent: 9,
                  ...
                  id: 9,
                  exponent: 9,
                  symbols: ['XAG', 'XAU', 'AUD', 'CAD', 'CHF', 'CNY', 'EUR', 'GBP', 'JPY', 'NOK', 'NZD']
                }];
                set = new Set();
