...
export class MsgClient {
  ...
  requestData(
    ...
    callback: (
      ...
      responseMessage: oracle_v1_tx_pb.MsgRequestDataResponse | null,
    ) => void,
  ): UnaryResponse
  requestData(
    requestMessage: oracle_v1_tx_pb.MsgRequestData,
  ...
  reportData(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_tx_pb.MsgReportDataResponse | null,
    ) => void,
  ): UnaryResponse
  reportData(
    requestMessage: oracle_v1_tx_pb.MsgReportData,
  ...
  createDataSource(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_tx_pb.MsgCreateDataSourceResponse | null,
    ) => void,
  ): UnaryResponse
  createDataSource(
    requestMessage: oracle_v1_tx_pb.MsgCreateDataSource,
  ...
  editDataSource(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_tx_pb.MsgEditDataSourceResponse | null,
    ) => void,
  ): UnaryResponse
  editDataSource(
    requestMessage: oracle_v1_tx_pb.MsgEditDataSource,
  ...
  createOracleScript(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_tx_pb.MsgCreateOracleScriptResponse | null,
    ) => void,
  ): UnaryResponse
  createOracleScript(
    requestMessage: oracle_v1_tx_pb.MsgCreateOracleScript,
  ...
  editOracleScript(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_tx_pb.MsgEditOracleScriptResponse | null,
    ) => void,
  ): UnaryResponse
  editOracleScript(
    requestMessage: oracle_v1_tx_pb.MsgEditOracleScript,
  ...
  activate(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_tx_pb.MsgActivateResponse | null,
    ) => void,
  ): UnaryResponse
  activate(
    requestMessage: oracle_v1_tx_pb.MsgActivate,
  ...
  updateParams(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_tx_pb.MsgUpdateParamsResponse | null,
    ) => void,
  ): UnaryResponse
  updateParams(
    requestMessage: oracle_v1_tx_pb.MsgUpdateParams,
