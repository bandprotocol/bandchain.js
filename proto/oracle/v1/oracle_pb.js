...
goog.exportSymbol('proto.oracle.v1.OracleResultRequestingSignature', null, global);
...
goog.exportSymbol('proto.oracle.v1.SigningResult', null, global);
 ...
 * @constructor
 */
proto.oracle.v1.SigningResult = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.oracle.v1.SigningResult, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.oracle.v1.SigningResult.displayName = 'proto.oracle.v1.SigningResult';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.oracle.v1.OracleResultRequestingSignature = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.oracle.v1.OracleResultRequestingSignature, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.oracle.v1.OracleResultRequestingSignature.displayName = 'proto.oracle.v1.OracleResultRequestingSignature';
}
 ...
 * @const
 */
proto.oracle.v1.Request.repeatedFields_ = [3,8,13];
...
proto.oracle.v1.Request.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    tssGroupId: jspb.Message.getFieldWithDefault(msg, 11, 0),
...
/**
 * optional uint64 tss_group_id = 11;
 * @return {number}
 */
proto.oracle.v1.Request.prototype.getTssGroupId = function() {
 ...
 * @return {!proto.oracle.v1.Request} returns this
 */
proto.oracle.v1.Request.prototype.setTssGroupId = function(value) {
 ...
 * @return {string}
 */
proto.oracle.v1.Request.prototype.getRequester = function() {
 ...
 * @return {!proto.oracle.v1.Request} returns this
 */
proto.oracle.v1.Request.prototype.setRequester = function(value) {
 ...
 * @return {!Array<!proto.cosmos.base.v1beta1.Coin>}
 */
proto.oracle.v1.Request.prototype.getFeeLimitList = function() {
  return /** @type{!Array<!proto.cosmos.base.v1beta1.Coin>} */ (
 ...
 * @return {!proto.oracle.v1.Request} returns this
*/
proto.oracle.v1.Request.prototype.setFeeLimitList = function(value) {
 ...
 * @return {!proto.cosmos.base.v1beta1.Coin}
 */
proto.oracle.v1.Request.prototype.addFeeLimit = function(opt_value, opt_index) {
 ...
 * @return {!proto.oracle.v1.Request} returns this
 */
proto.oracle.v1.Request.prototype.clearFeeLimitList = function() {
...
proto.oracle.v1.OracleRequestPacketData.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    tssGroupId: jspb.Message.getFieldWithDefault(msg, 9, 0)
  };
...
/**
 * optional uint64 tss_group_id = 9;
 * @return {number}
 */
proto.oracle.v1.OracleRequestPacketData.prototype.getTssGroupId = function() {
 ...
 * @return {!proto.oracle.v1.OracleRequestPacketData} returns this
 */
proto.oracle.v1.OracleRequestPacketData.prototype.setTssGroupId = function(value) {
 ...
 * @return {!Object}
 */
proto.oracle.v1.SigningResult.prototype.toObject = function(opt_includeInstance) {
  return proto.oracle.v1.SigningResult.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.oracle.v1.SigningResult} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.oracle.v1.SigningResult.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.oracle.v1.SigningResult.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.oracle.v1.SigningResult;
  return proto.oracle.v1.SigningResult.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.oracle.v1.SigningResult} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.oracle.v1.SigningResult}
 */
proto.oracle.v1.SigningResult.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.oracle.v1.SigningResult.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.oracle.v1.SigningResult.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.oracle.v1.SigningResult} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.oracle.v1.SigningResult.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.oracle.v1.SigningResult.prototype.getSigningId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.oracle.v1.SigningResult} returns this
 */
proto.oracle.v1.SigningResult.prototype.setSigningId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.oracle.v1.SigningResult.prototype.getErrorCodespace = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.oracle.v1.SigningResult} returns this
 */
proto.oracle.v1.SigningResult.prototype.setErrorCodespace = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.oracle.v1.SigningResult.prototype.getErrorCode = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.oracle.v1.SigningResult} returns this
 */
proto.oracle.v1.SigningResult.prototype.setErrorCode = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
 ...
 * @return {!Object}
 */
proto.oracle.v1.OracleResultRequestingSignature.prototype.toObject = function(opt_includeInstance) {
  return proto.oracle.v1.OracleResultRequestingSignature.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.oracle.v1.OracleResultRequestingSignature} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.oracle.v1.OracleResultRequestingSignature.toObject = function(includeInstance, msg) {
  var f, obj = {
    requestId: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.oracle.v1.OracleResultRequestingSignature}
 */
proto.oracle.v1.OracleResultRequestingSignature.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.oracle.v1.OracleResultRequestingSignature;
  return proto.oracle.v1.OracleResultRequestingSignature.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.oracle.v1.OracleResultRequestingSignature} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.oracle.v1.OracleResultRequestingSignature}
 */
proto.oracle.v1.OracleResultRequestingSignature.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.oracle.v1.OracleResultRequestingSignature.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.oracle.v1.OracleResultRequestingSignature.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.oracle.v1.OracleResultRequestingSignature} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.oracle.v1.OracleResultRequestingSignature.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getRequestId();
  if (f !== 0) {
    writer.writeUint64(
 ...
 * @return {number}
 */
proto.oracle.v1.OracleResultRequestingSignature.prototype.getRequestId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.oracle.v1.OracleResultRequestingSignature} returns this
 */
proto.oracle.v1.OracleResultRequestingSignature.prototype.setRequestId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
