...
goog.exportSymbol('proto.oracle.v1.ReportersPerValidator', null, global);
 ...
 * @constructor
 */
proto.oracle.v1.ReportersPerValidator = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.oracle.v1.ReportersPerValidator.repeatedFields_, null);
};
goog.inherits(proto.oracle.v1.ReportersPerValidator, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.oracle.v1.ReportersPerValidator.displayName = 'proto.oracle.v1.ReportersPerValidator';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
/**
 * optional int64 data_source_id = 2;
 * @return {number}
 */
...
/**
 * optional uint64 request_time = 6;
 * @return {number}
 */
...
proto.oracle.v1.OracleRequestPacketData.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    cosmos_base_v1beta1_coin_pb.Coin.toObject, includeInstance),
    requestKey: jspb.Message.getFieldWithDefault(msg, 7, ""),
    prepareGas: jspb.Message.getFieldWithDefault(msg, 8, 0),
    executeGas: jspb.Message.getFieldWithDefault(msg, 9, 0)
  };
...
/**
 * optional string request_key = 7;
 * @return {string}
 */
proto.oracle.v1.OracleRequestPacketData.prototype.getRequestKey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 7, ""));
};
 ...
 * @return {!proto.oracle.v1.OracleRequestPacketData} returns this
 */
proto.oracle.v1.OracleRequestPacketData.prototype.setRequestKey = function(value) {
  return jspb.Message.setProto3StringField(this, 7, value);
};


/**
 * optional uint64 prepare_gas = 8;
 * @return {number}
 */
...
proto.oracle.v1.Params.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    expirationBlockCount: jspb.Message.getFieldWithDefault(msg, 3, 0),
    baseOwasmGas: jspb.Message.getFieldWithDefault(msg, 4, 0),
    perValidatorRequestGas: jspb.Message.getFieldWithDefault(msg, 5, 0),
    samplingTryCount: jspb.Message.getFieldWithDefault(msg, 6, 0),
    oracleRewardPercentage: jspb.Message.getFieldWithDefault(msg, 7, 0),
    inactivePenaltyDuration: jspb.Message.getFieldWithDefault(msg, 8, 0),
    ibcRequestEnabled: jspb.Message.getBooleanFieldWithDefault(msg, 9, false)
  };
...
/**
 * optional uint64 expiration_block_count = 3;
 * @return {number}
 */
...
/**
 * optional uint64 base_owasm_gas = 4;
 * @return {number}
 */
...
/**
 * optional uint64 per_validator_request_gas = 5;
 * @return {number}
 */
...
/**
 * optional uint64 sampling_try_count = 6;
 * @return {number}
 */
...
/**
 * optional uint64 oracle_reward_percentage = 7;
 * @return {number}
 */
...
/**
 * optional uint64 inactive_penalty_duration = 8;
 * @return {number}
 */
...
/**
 * optional bool ibc_request_enabled = 9;
 * @return {boolean}
 */
 ...
 * @const
 */
proto.oracle.v1.ReportersPerValidator.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.oracle.v1.ReportersPerValidator.prototype.toObject = function(opt_includeInstance) {
  return proto.oracle.v1.ReportersPerValidator.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.oracle.v1.ReportersPerValidator} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.oracle.v1.ReportersPerValidator.toObject = function(includeInstance, msg) {
  var f, obj = {
    validator: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 */
proto.oracle.v1.ReportersPerValidator.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.oracle.v1.ReportersPerValidator;
  return proto.oracle.v1.ReportersPerValidator.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.oracle.v1.ReportersPerValidator} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.oracle.v1.ReportersPerValidator}
 */
proto.oracle.v1.ReportersPerValidator.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.oracle.v1.ReportersPerValidator.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.oracle.v1.ReportersPerValidator.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.oracle.v1.ReportersPerValidator} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.oracle.v1.ReportersPerValidator.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getValidator();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.oracle.v1.ReportersPerValidator.prototype.getValidator = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.oracle.v1.ReportersPerValidator} returns this
 */
proto.oracle.v1.ReportersPerValidator.prototype.setValidator = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Array<string>}
 */
proto.oracle.v1.ReportersPerValidator.prototype.getReportersList = function() {
 ...
 * @return {!proto.oracle.v1.ReportersPerValidator} returns this
 */
proto.oracle.v1.ReportersPerValidator.prototype.setReportersList = function(value) {
 ...
 * @return {!proto.oracle.v1.ReportersPerValidator} returns this
 */
proto.oracle.v1.ReportersPerValidator.prototype.addReporters = function(value, opt_index) {
 ...
 * @return {!proto.oracle.v1.ReportersPerValidator} returns this
 */
proto.oracle.v1.ReportersPerValidator.prototype.clearReportersList = function() {
