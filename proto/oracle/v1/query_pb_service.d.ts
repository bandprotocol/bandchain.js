...
export class QueryClient {
  ...
  counts(
    ...
    callback: (
      ...
      responseMessage: oracle_v1_query_pb.QueryCountsResponse | null,
    ) => void,
  ): UnaryResponse
  counts(
    requestMessage: oracle_v1_query_pb.QueryCountsRequest,
  ...
  data(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_query_pb.QueryDataResponse | null,
    ) => void,
  ): UnaryResponse
  data(
    requestMessage: oracle_v1_query_pb.QueryDataRequest,
  ...
  dataSource(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_query_pb.QueryDataSourceResponse | null,
    ) => void,
  ): UnaryResponse
  dataSource(
    requestMessage: oracle_v1_query_pb.QueryDataSourceRequest,
  ...
  oracleScript(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_query_pb.QueryOracleScriptResponse | null,
    ) => void,
  ): UnaryResponse
  oracleScript(
    requestMessage: oracle_v1_query_pb.QueryOracleScriptRequest,
  ...
  request(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_query_pb.QueryRequestResponse | null,
    ) => void,
  ): UnaryResponse
  request(
    requestMessage: oracle_v1_query_pb.QueryRequestRequest,
  ...
  pendingRequests(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_query_pb.QueryPendingRequestsResponse | null,
    ) => void,
  ): UnaryResponse
  pendingRequests(
    requestMessage: oracle_v1_query_pb.QueryPendingRequestsRequest,
  ...
  validator(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_query_pb.QueryValidatorResponse | null,
    ) => void,
  ): UnaryResponse
  validator(
    requestMessage: oracle_v1_query_pb.QueryValidatorRequest,
  ...
  isReporter(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_query_pb.QueryIsReporterResponse | null,
    ) => void,
  ): UnaryResponse
  isReporter(
    requestMessage: oracle_v1_query_pb.QueryIsReporterRequest,
  ...
  reporters(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_query_pb.QueryReportersResponse | null,
    ) => void,
  ): UnaryResponse
  reporters(
    requestMessage: oracle_v1_query_pb.QueryReportersRequest,
  ...
  activeValidators(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_query_pb.QueryActiveValidatorsResponse | null,
    ) => void,
  ): UnaryResponse
  activeValidators(
    requestMessage: oracle_v1_query_pb.QueryActiveValidatorsRequest,
  ...
  params(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_query_pb.QueryParamsResponse | null,
    ) => void,
  ): UnaryResponse
  params(
    requestMessage: oracle_v1_query_pb.QueryParamsRequest,
  ...
  requestSearch(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_query_pb.QueryRequestSearchResponse | null,
    ) => void,
  ): UnaryResponse
  requestSearch(
    requestMessage: oracle_v1_query_pb.QueryRequestSearchRequest,
  ...
  requestPrice(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_query_pb.QueryRequestPriceResponse | null,
    ) => void,
  ): UnaryResponse
  requestPrice(
    requestMessage: oracle_v1_query_pb.QueryRequestPriceRequest,
  ...
  requestVerification(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: oracle_v1_query_pb.QueryRequestVerificationResponse | null,
    ) => void,
  ): UnaryResponse
  requestVerification(
    requestMessage: oracle_v1_query_pb.QueryRequestVerificationRequest,
