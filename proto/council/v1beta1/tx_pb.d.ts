...
export class MsgSubmitProposal extends jspb.Message { 
    getCouncil(): council_v1beta1_types_pb.CouncilType;
    setCouncil(value: council_v1beta1_types_pb.CouncilType): MsgSubmitProposal;
    getProposer(): string;
    ...
    getTitle(): string;
    setTitle(value: string): MsgSubmitProposal;
    getMetadata(): string;
...
export namespace MsgSubmitProposal {
    export type AsObject = {
        council: council_v1beta1_types_pb.CouncilType,
        proposer: string,
...
export class MsgExecLegacyContent extends jspb.Message { 
    getCouncil(): council_v1beta1_types_pb.CouncilType;
    setCouncil(value: council_v1beta1_types_pb.CouncilType): MsgExecLegacyContent;
...
export class MsgVote extends jspb.Message { 
    ...
    getOption(): council_v1beta1_types_pb.VoteOption;
    setOption(value: council_v1beta1_types_pb.VoteOption): MsgVote;
...
export namespace MsgVote {
    export type AsObject = {
        proposalId: number,
        voter: string,
        option: council_v1beta1_types_pb.VoteOption,
    }
}
