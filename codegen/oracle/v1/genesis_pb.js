...
proto.oracle.v1.GenesisState = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.oracle.v1.GenesisState.repeatedFields_,
    null,
  )
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.oracle.v1.GenesisState.prototype.toObject = function (
    opt_includeInstance,
  ) {
  ...
  proto.oracle.v1.GenesisState.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        dataSourcesList: jspb.Message.toObjectList(
          msg.getDataSourcesList(),
          oracle_v1_oracle_pb.DataSource.toObject,
          includeInstance,
        ),
        oracleScriptsList: jspb.Message.toObjectList(
          msg.getOracleScriptsList(),
          oracle_v1_oracle_pb.OracleScript.toObject,
          includeInstance,
        ),
      }
 ...
 * @return {!proto.oracle.v1.GenesisState}
 */
proto.oracle.v1.GenesisState.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.oracle.v1.GenesisState.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.oracle.v1.GenesisState.prototype.addDataSources = function (
  opt_value,
  opt_index,
) {
 ...
 */
proto.oracle.v1.GenesisState.prototype.addOracleScripts = function (
  opt_value,
  opt_index,
) {
  return jspb.Message.addToRepeatedWrapperField(
