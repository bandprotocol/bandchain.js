...
export namespace capability.v1 {
    export class GenesisOwners extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            index?: number;
            index_owners?: dependency_2.capability.v1.CapabilityOwners;
        }) {
            super();
        ...
        get index_owners() {
            return pb_1.Message.getWrapperField(this, dependency_2.capability.v1.CapabilityOwners, 2) as dependency_2.capability.v1.CapabilityOwners;
        }
        set index_owners(value: dependency_2.capability.v1.CapabilityOwners) {
        ...
        static fromObject(data: {
            index?: number;
            index_owners?: ReturnType<typeof dependency_2.capability.v1.CapabilityOwners.prototype.toObject>;
        }): GenesisOwners {
            ...
            if (data.index_owners != null) {
                message.index_owners = dependency_2.capability.v1.CapabilityOwners.fromObject(data.index_owners);
            }
            return message;
        }
        toObject() {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.index_owners, () => message.index_owners = dependency_2.capability.v1.CapabilityOwners.deserialize(reader));
                        break;
