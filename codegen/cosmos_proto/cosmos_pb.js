...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos_proto.InterfaceDescriptor.displayName =
...
proto.cosmos_proto.ScalarDescriptor = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.cosmos_proto.ScalarDescriptor.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos_proto.ScalarDescriptor.displayName =
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos_proto.InterfaceDescriptor.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos_proto.InterfaceDescriptor.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.cosmos_proto.InterfaceDescriptor.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.cosmos_proto.InterfaceDescriptor.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos_proto.InterfaceDescriptor.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos_proto.InterfaceDescriptor}
 */
proto.cosmos_proto.InterfaceDescriptor.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos_proto.InterfaceDescriptor.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 * @return {!proto.cosmos_proto.InterfaceDescriptor} returns this
 */
proto.cosmos_proto.InterfaceDescriptor.prototype.setDescription = function (
  value,
) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos_proto.ScalarDescriptor.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos_proto.ScalarDescriptor.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.cosmos_proto.ScalarDescriptor.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.cosmos_proto.ScalarDescriptor.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos_proto.ScalarDescriptor.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos_proto.ScalarDescriptor}
 */
proto.cosmos_proto.ScalarDescriptor.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 2:
        ...
        break
      case 3:
        var values = /** @type {!Array<!proto.cosmos_proto.ScalarType>} */ (
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos_proto.ScalarDescriptor.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 * @return {!proto.cosmos_proto.ScalarDescriptor} returns this
 */
proto.cosmos_proto.ScalarDescriptor.prototype.setDescription = function (
  value,
) {
  return jspb.Message.setProto3StringField(this, 2, value)
}
...
proto.cosmos_proto.ScalarDescriptor.prototype.getFieldTypeList = function () {
  return /** @type {!Array<!proto.cosmos_proto.ScalarType>} */ (
 ...
 * @return {!proto.cosmos_proto.ScalarDescriptor} returns this
 */
proto.cosmos_proto.ScalarDescriptor.prototype.setFieldTypeList = function (
  value,
) {
 ...
 * @return {!proto.cosmos_proto.ScalarDescriptor} returns this
 */
proto.cosmos_proto.ScalarDescriptor.prototype.addFieldType = function (
  value,
  opt_index,
) {
...
google_protobuf_descriptor_pb.MethodOptions.extensionsBinary[93001] =
...
google_protobuf_descriptor_pb.MethodOptions.extensions[93001] =
  proto.cosmos_proto.methodAddedIn
...
google_protobuf_descriptor_pb.FieldOptions.extensionsBinary[93002] =
  new jspb.ExtensionFieldBinaryInfo(
...
// This registers the extension field with the extended class, so that
// toObject() will function correctly.
google_protobuf_descriptor_pb.FieldOptions.extensions[93002] =
  proto.cosmos_proto.scalar
...
google_protobuf_descriptor_pb.FieldOptions.extensionsBinary[93003] =
  new jspb.ExtensionFieldBinaryInfo(
...
// This registers the extension field with the extended class, so that
// toObject() will function correctly.
google_protobuf_descriptor_pb.FieldOptions.extensions[93003] =
  proto.cosmos_proto.fieldAddedIn
...
google_protobuf_descriptor_pb.FileOptions.extensionsBinary[793021] =
  new jspb.ExtensionFieldBinaryInfo(
...
// This registers the extension field with the extended class, so that
// toObject() will function correctly.
google_protobuf_descriptor_pb.FileOptions.extensions[793021] =
  proto.cosmos_proto.declareInterfaceList
...
google_protobuf_descriptor_pb.FileOptions.extensionsBinary[793022] =
  new jspb.ExtensionFieldBinaryInfo(
...
// This registers the extension field with the extended class, so that
// toObject() will function correctly.
google_protobuf_descriptor_pb.FileOptions.extensions[793022] =
  proto.cosmos_proto.declareScalarList
...
google_protobuf_descriptor_pb.FileOptions.extensionsBinary[793023] =
  new jspb.ExtensionFieldBinaryInfo(
...
// This registers the extension field with the extended class, so that
// toObject() will function correctly.
google_protobuf_descriptor_pb.FileOptions.extensions[793023] =
  proto.cosmos_proto.fileAddedIn
