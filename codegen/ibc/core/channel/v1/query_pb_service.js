...
Query.UpgradeError = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: ibc_core_channel_v1_query_pb.QueryUpgradeErrorRequest,
  responseType: ibc_core_channel_v1_query_pb.QueryUpgradeErrorResponse
};
...
Query.Upgrade = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: ibc_core_channel_v1_query_pb.QueryUpgradeRequest,
  responseType: ibc_core_channel_v1_query_pb.QueryUpgradeResponse
};
...
Query.ChannelParams = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: ibc_core_channel_v1_query_pb.QueryChannelParamsRequest,
  responseType: ibc_core_channel_v1_query_pb.QueryChannelParamsResponse
};
...
QueryClient.prototype.nextSequenceSend = function nextSequenceSend(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Query.NextSequenceSend, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
QueryClient.prototype.upgradeError = function upgradeError(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Query.UpgradeError, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
QueryClient.prototype.upgrade = function upgrade(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Query.Upgrade, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
QueryClient.prototype.channelParams = function channelParams(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Query.ChannelParams, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
