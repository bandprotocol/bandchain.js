...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.ibc.core.channel.v1.Upgrade.displayName =
    'proto.ibc.core.channel.v1.Upgrade'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.ibc.core.channel.v1.UpgradeFields = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.ibc.core.channel.v1.UpgradeFields.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.ibc.core.channel.v1.UpgradeFields.displayName =
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.ibc.core.channel.v1.ErrorReceipt.displayName =
    'proto.ibc.core.channel.v1.ErrorReceipt'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.ibc.core.channel.v1.Upgrade.prototype.toObject = function (
    opt_includeInstance,
  ) {
  ...
  proto.ibc.core.channel.v1.Upgrade.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        fields:
          (f = msg.getFields()) &&
          proto.ibc.core.channel.v1.UpgradeFields.toObject(includeInstance, f),
        timeout:
          (f = msg.getTimeout()) &&
          ibc_core_channel_v1_channel_pb.Timeout.toObject(includeInstance, f),
...
proto.ibc.core.channel.v1.Upgrade.deserializeBinary = function (bytes) {
  ...
  return proto.ibc.core.channel.v1.Upgrade.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.ibc.core.channel.v1.Upgrade}
 */
proto.ibc.core.channel.v1.Upgrade.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.ibc.core.channel.v1.UpgradeFields.deserializeBinaryFromReader,
        )
        msg.setFields(value)
        break
      case 2:
        ...
        reader.readMessage(
          value,
          ibc_core_channel_v1_channel_pb.Timeout.deserializeBinaryFromReader,
        )
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ibc.core.channel.v1.Upgrade.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
...
proto.ibc.core.channel.v1.Upgrade.prototype.getTimeout = function () {
  return /** @type{?proto.ibc.core.channel.v1.Timeout} */ (
    jspb.Message.getWrapperField(
      this,
      ibc_core_channel_v1_channel_pb.Timeout,
      2,
    )
  )
}
 ...
 * @return {!proto.ibc.core.channel.v1.Upgrade} returns this
 */
proto.ibc.core.channel.v1.Upgrade.prototype.setNextSequenceSend = function (
  value,
) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.ibc.core.channel.v1.UpgradeFields.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.ibc.core.channel.v1.UpgradeFields.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.ibc.core.channel.v1.UpgradeFields.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.ibc.core.channel.v1.UpgradeFields.deserializeBinary = function (bytes) {
  ...
  return proto.ibc.core.channel.v1.UpgradeFields.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.ibc.core.channel.v1.UpgradeFields}
 */
proto.ibc.core.channel.v1.UpgradeFields.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @return {!Uint8Array}
 */
proto.ibc.core.channel.v1.UpgradeFields.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
    proto.ibc.core.channel.v1.UpgradeFields.serializeBinaryToWriter(
      this,
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ibc.core.channel.v1.UpgradeFields.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.ibc.core.channel.v1.UpgradeFields.prototype.setOrdering = function (
  value,
) {
 ...
 * @return {!Array<string>}
 */
proto.ibc.core.channel.v1.UpgradeFields.prototype.getConnectionHopsList =
  function () {
 ...
 * @return {!proto.ibc.core.channel.v1.UpgradeFields} returns this
 */
proto.ibc.core.channel.v1.UpgradeFields.prototype.setConnectionHopsList =
  function (value) {
 ...
 * @return {!proto.ibc.core.channel.v1.UpgradeFields} returns this
 */
proto.ibc.core.channel.v1.UpgradeFields.prototype.addConnectionHops = function (
  value,
  opt_index,
) {
 ...
 * @return {!proto.ibc.core.channel.v1.UpgradeFields} returns this
 */
proto.ibc.core.channel.v1.UpgradeFields.prototype.clearConnectionHopsList =
  function () {
 ...
 * @return {!proto.ibc.core.channel.v1.UpgradeFields} returns this
 */
proto.ibc.core.channel.v1.UpgradeFields.prototype.setVersion = function (
  value,
) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.ibc.core.channel.v1.ErrorReceipt.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.ibc.core.channel.v1.ErrorReceipt.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.ibc.core.channel.v1.ErrorReceipt.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.ibc.core.channel.v1.ErrorReceipt.deserializeBinary = function (bytes) {
  ...
  return proto.ibc.core.channel.v1.ErrorReceipt.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.ibc.core.channel.v1.ErrorReceipt}
 */
proto.ibc.core.channel.v1.ErrorReceipt.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ibc.core.channel.v1.ErrorReceipt.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.ibc.core.channel.v1.ErrorReceipt.prototype.setSequence = function (
  value,
) {
