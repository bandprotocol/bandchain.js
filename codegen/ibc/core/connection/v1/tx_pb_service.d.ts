...
type MsgUpdateConnectionParams = {
  readonly methodName: string;
  readonly service: typeof Msg;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof ibc_core_connection_v1_tx_pb.MsgUpdateParams;
  readonly responseType: typeof ibc_core_connection_v1_tx_pb.MsgUpdateParamsResponse;
};
...
export class Msg {
  ...
  static readonly UpdateConnectionParams: MsgUpdateConnectionParams;
}
...
export class MsgClient {
  ...
  updateConnectionParams(
    requestMessage: ibc_core_connection_v1_tx_pb.MsgUpdateParams,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: ibc_core_connection_v1_tx_pb.MsgUpdateParamsResponse|null) => void
  ): UnaryResponse;
  updateConnectionParams(
    requestMessage: ibc_core_connection_v1_tx_pb.MsgUpdateParams,
    callback: (error: ServiceError|null, responseMessage: ibc_core_connection_v1_tx_pb.MsgUpdateParamsResponse|null) => void
