...
proto.ibc.core.connection.v1.GenesisState = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.ibc.core.connection.v1.GenesisState.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.ibc.core.connection.v1.GenesisState.displayName =
    'proto.ibc.core.connection.v1.GenesisState'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.ibc.core.connection.v1.GenesisState.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.ibc.core.connection.v1.GenesisState.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.ibc.core.connection.v1.GenesisState.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
      obj = {
        ...
        clientConnectionPathsList: jspb.Message.toObjectList(
          msg.getClientConnectionPathsList(),
          ibc_core_connection_v1_connection_pb.ConnectionPaths.toObject,
          includeInstance,
        ),
...
proto.ibc.core.connection.v1.GenesisState.deserializeBinary = function (bytes) {
  ...
  return proto.ibc.core.connection.v1.GenesisState.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.ibc.core.connection.v1.GenesisState}
 */
proto.ibc.core.connection.v1.GenesisState.deserializeBinaryFromReader =
  function (msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.ibc.core.connection.v1.GenesisState.prototype.serializeBinary =
  function () {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ibc.core.connection.v1.GenesisState.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.ibc.core.connection.v1.GenesisState.prototype.getConnectionsList =
  function () {
 ...
 */
proto.ibc.core.connection.v1.GenesisState.prototype.setConnectionsList =
  function (value) {
 ...
 */
proto.ibc.core.connection.v1.GenesisState.prototype.addConnections = function (
  opt_value,
  opt_index,
) {
 ...
 * @return {!proto.ibc.core.connection.v1.GenesisState} returns this
 */
proto.ibc.core.connection.v1.GenesisState.prototype.clearConnectionsList =
  function () {
 ...
 */
proto.ibc.core.connection.v1.GenesisState.prototype.getClientConnectionPathsList =
  function () {
 ...
 * @return {!proto.ibc.core.connection.v1.GenesisState} returns this
 */
proto.ibc.core.connection.v1.GenesisState.prototype.setClientConnectionPathsList =
  function (value) {
 ...
 */
proto.ibc.core.connection.v1.GenesisState.prototype.addClientConnectionPaths =
 ...
 * @return {!proto.ibc.core.connection.v1.GenesisState} returns this
 */
proto.ibc.core.connection.v1.GenesisState.prototype.clearClientConnectionPathsList =
  function () {
 ...
 * @return {number}
 */
proto.ibc.core.connection.v1.GenesisState.prototype.getNextConnectionSequence =
  function () {
 ...
 * @return {!proto.ibc.core.connection.v1.GenesisState} returns this
 */
proto.ibc.core.connection.v1.GenesisState.prototype.setNextConnectionSequence =
  function (value) {
 ...
 * @return {!proto.ibc.core.connection.v1.GenesisState} returns this
 */
proto.ibc.core.connection.v1.GenesisState.prototype.setParams = function (
  value,
) {
