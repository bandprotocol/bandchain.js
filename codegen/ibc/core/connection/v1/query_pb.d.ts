...
export class QueryConnectionParamsRequest extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): QueryConnectionParamsRequest.AsObject;
  static toObject(includeInstance: boolean, msg: QueryConnectionParamsRequest): QueryConnectionParamsRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: QueryConnectionParamsRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): QueryConnectionParamsRequest;
  static deserializeBinaryFromReader(message: QueryConnectionParamsRequest, reader: jspb.BinaryReader): QueryConnectionParamsRequest;
}

export namespace QueryConnectionParamsRequest {
  export type AsObject = {
  }
}

export class QueryConnectionParamsResponse extends jspb.Message {
  hasParams(): boolean;
  clearParams(): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): QueryConnectionParamsResponse.AsObject;
  static toObject(includeInstance: boolean, msg: QueryConnectionParamsResponse): QueryConnectionParamsResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: QueryConnectionParamsResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): QueryConnectionParamsResponse;
  static deserializeBinaryFromReader(message: QueryConnectionParamsResponse, reader: jspb.BinaryReader): QueryConnectionParamsResponse;
}

export namespace QueryConnectionParamsResponse {
  export type AsObject = {
