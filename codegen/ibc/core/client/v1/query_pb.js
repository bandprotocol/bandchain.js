...
proto.ibc.core.client.v1.QueryVerifyMembershipRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proof: msg.getProof_asB64(),
    proofHeight: (f = msg.getProofHeight()) && ibc_core_client_v1_client_pb.Height.toObject(includeInstance, f),
    merklePath: (f = msg.getMerklePath()) && ibc_core_commitment_v1_commitment_pb.MerklePath.toObject(includeInstance, f),
...
proto.ibc.core.client.v1.QueryVerifyMembershipRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      reader.readMessage(value,ibc_core_commitment_v1_commitment_pb.MerklePath.deserializeBinaryFromReader);
...
proto.ibc.core.client.v1.QueryVerifyMembershipRequest.prototype.getMerklePath = function() {
  return /** @type{?proto.ibc.core.commitment.v1.MerklePath} */ (
    jspb.Message.getWrapperField(this, ibc_core_commitment_v1_commitment_pb.MerklePath, 4));
};
