...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.ibc.core.commitment.v1.MerkleRoot.displayName =
    'proto.ibc.core.commitment.v1.MerkleRoot'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.ibc.core.commitment.v1.MerklePrefix.displayName =
...
proto.ibc.core.commitment.v1.MerklePath = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.ibc.core.commitment.v1.MerklePath.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.ibc.core.commitment.v1.MerklePath.displayName =
...
proto.ibc.core.commitment.v1.MerkleProof = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.ibc.core.commitment.v1.MerkleProof.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.ibc.core.commitment.v1.MerkleProof.displayName =
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.ibc.core.commitment.v1.MerkleRoot.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.ibc.core.commitment.v1.MerkleRoot.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.ibc.core.commitment.v1.MerkleRoot.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.ibc.core.commitment.v1.MerkleRoot.deserializeBinary = function (bytes) {
  ...
  return proto.ibc.core.commitment.v1.MerkleRoot.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.ibc.core.commitment.v1.MerkleRoot}
 */
proto.ibc.core.commitment.v1.MerkleRoot.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
 ...
 * @return {!Uint8Array}
 */
proto.ibc.core.commitment.v1.MerkleRoot.prototype.serializeBinary =
  function () {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ibc.core.commitment.v1.MerkleRoot.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.ibc.core.commitment.v1.MerklePrefix.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.ibc.core.commitment.v1.MerklePrefix.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.ibc.core.commitment.v1.MerklePrefix.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.ibc.core.commitment.v1.MerklePrefix.deserializeBinary = function (bytes) {
  ...
  return proto.ibc.core.commitment.v1.MerklePrefix.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.ibc.core.commitment.v1.MerklePrefix}
 */
proto.ibc.core.commitment.v1.MerklePrefix.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break
 ...
 * @return {!Uint8Array}
 */
proto.ibc.core.commitment.v1.MerklePrefix.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ibc.core.commitment.v1.MerklePrefix.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 * @return {string}
 */
proto.ibc.core.commitment.v1.MerklePrefix.prototype.getKeyPrefix_asB64 =
  function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getKeyPrefix()))
  }
 ...
 * @return {!Uint8Array}
 */
proto.ibc.core.commitment.v1.MerklePrefix.prototype.getKeyPrefix_asU8 =
  function () {
    return /** @type {!Uint8Array} */ (
      jspb.Message.bytesAsU8(this.getKeyPrefix())
    )
  }
 ...
 */
proto.ibc.core.commitment.v1.MerklePrefix.prototype.setKeyPrefix = function (
  value,
) {
  return jspb.Message.setProto3BytesField(this, 1, value)
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.ibc.core.commitment.v1.MerklePath.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.ibc.core.commitment.v1.MerklePath.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.ibc.core.commitment.v1.MerklePath.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.ibc.core.commitment.v1.MerklePath.deserializeBinary = function (bytes) {
  ...
  return proto.ibc.core.commitment.v1.MerklePath.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.ibc.core.commitment.v1.MerklePath}
 */
proto.ibc.core.commitment.v1.MerklePath.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @return {!Uint8Array}
 */
proto.ibc.core.commitment.v1.MerklePath.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
    proto.ibc.core.commitment.v1.MerklePath.serializeBinaryToWriter(
      this,
      writer,
    )
    return writer.getResultBuffer()
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ibc.core.commitment.v1.MerklePath.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.ibc.core.commitment.v1.MerklePath.prototype.setKeyPathList = function (
  value,
) {
 ...
 * @return {!proto.ibc.core.commitment.v1.MerklePath} returns this
 */
proto.ibc.core.commitment.v1.MerklePath.prototype.addKeyPath = function (
  value,
  opt_index,
) {
 ...
 * @return {!proto.ibc.core.commitment.v1.MerklePath} returns this
 */
proto.ibc.core.commitment.v1.MerklePath.prototype.clearKeyPathList =
  function () {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.ibc.core.commitment.v1.MerkleProof.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.ibc.core.commitment.v1.MerkleProof.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.ibc.core.commitment.v1.MerkleProof.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
      obj = {
        proofsList: jspb.Message.toObjectList(
          msg.getProofsList(),
          cosmos_ics23_v1_proofs_pb.CommitmentProof.toObject,
          includeInstance,
        ),
      }
...
proto.ibc.core.commitment.v1.MerkleProof.deserializeBinary = function (bytes) {
  ...
  return proto.ibc.core.commitment.v1.MerkleProof.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.ibc.core.commitment.v1.MerkleProof}
 */
proto.ibc.core.commitment.v1.MerkleProof.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break
      ...
      switch (field) {
        case 1:
          ...
          reader.readMessage(
            value,
            cosmos_ics23_v1_proofs_pb.CommitmentProof
 ...
 * @return {!Uint8Array}
 */
proto.ibc.core.commitment.v1.MerkleProof.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
    proto.ibc.core.commitment.v1.MerkleProof.serializeBinaryToWriter(
      this,
      writer,
    )
    return writer.getResultBuffer()
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ibc.core.commitment.v1.MerkleProof.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.ibc.core.commitment.v1.MerkleProof.prototype.setProofsList = function (
  value,
) {
 ...
 */
proto.ibc.core.commitment.v1.MerkleProof.prototype.addProofs = function (
  opt_value,
  opt_index,
) {
  return jspb.Message.addToRepeatedWrapperField(
    ...
    1,
    opt_value,
    proto.cosmos.ics23.v1.CommitmentProof,
    opt_index,
  )
}
 ...
 * @return {!proto.ibc.core.commitment.v1.MerkleProof} returns this
 */
proto.ibc.core.commitment.v1.MerkleProof.prototype.clearProofsList =
  function () {
