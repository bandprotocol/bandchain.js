...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.ibc.core.types.v1.GenesisState.displayName =
    'proto.ibc.core.types.v1.GenesisState'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.ibc.core.types.v1.GenesisState.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.ibc.core.types.v1.GenesisState.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.ibc.core.types.v1.GenesisState.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
      obj = {
        clientGenesis:
          (f = msg.getClientGenesis()) &&
          ibc_core_client_v1_genesis_pb.GenesisState.toObject(
            includeInstance,
            f,
          ),
        connectionGenesis:
          (f = msg.getConnectionGenesis()) &&
          ibc_core_connection_v1_genesis_pb.GenesisState.toObject(
            includeInstance,
            f,
          ),
        channelGenesis:
          (f = msg.getChannelGenesis()) &&
          ibc_core_channel_v1_genesis_pb.GenesisState.toObject(
            includeInstance,
            f,
          ),
      }
...
proto.ibc.core.types.v1.GenesisState.deserializeBinary = function (bytes) {
  ...
  return proto.ibc.core.types.v1.GenesisState.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.ibc.core.types.v1.GenesisState}
 */
proto.ibc.core.types.v1.GenesisState.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          ibc_core_client_v1_genesis_pb.GenesisState
      ...
      case 3:
        ...
        reader.readMessage(
          value,
          ibc_core_channel_v1_genesis_pb.GenesisState
            .deserializeBinaryFromReader,
        )
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ibc.core.types.v1.GenesisState.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.ibc.core.types.v1.GenesisState.prototype.setClientGenesis = function (
  value,
) {
 ...
 * @return {!proto.ibc.core.types.v1.GenesisState} returns this
 */
proto.ibc.core.types.v1.GenesisState.prototype.clearClientGenesis =
  function () {
 ...
 */
proto.ibc.core.types.v1.GenesisState.prototype.getConnectionGenesis =
  function () {
 ...
 * @return {!proto.ibc.core.types.v1.GenesisState} returns this
 */
proto.ibc.core.types.v1.GenesisState.prototype.setConnectionGenesis = function (
  value,
) {
 ...
 * @return {!proto.ibc.core.types.v1.GenesisState} returns this
 */
proto.ibc.core.types.v1.GenesisState.prototype.clearConnectionGenesis =
  function () {
 ...
 * @return {boolean}
 */
proto.ibc.core.types.v1.GenesisState.prototype.hasConnectionGenesis =
  function () {
 ...
 * @return {!proto.ibc.core.types.v1.GenesisState} returns this
 */
proto.ibc.core.types.v1.GenesisState.prototype.setChannelGenesis = function (
  value,
) {
 ...
 * @return {!proto.ibc.core.types.v1.GenesisState} returns this
 */
proto.ibc.core.types.v1.GenesisState.prototype.clearChannelGenesis =
  function () {
