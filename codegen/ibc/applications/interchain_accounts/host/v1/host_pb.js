...
goog.exportSymbol('proto.ibc.applications.interchain_accounts.host.v1.QueryRequest', null, global);
/**
 ...
 * @constructor
 */
proto.ibc.applications.interchain_accounts.host.v1.QueryRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.ibc.applications.interchain_accounts.host.v1.QueryRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.ibc.applications.interchain_accounts.host.v1.QueryRequest.displayName = 'proto.ibc.applications.interchain_accounts.host.v1.QueryRequest';
}
 ...
 * @return {!Object}
 */
proto.ibc.applications.interchain_accounts.host.v1.QueryRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.ibc.applications.interchain_accounts.host.v1.QueryRequest.toObject(opt_includeInstance, this);
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ibc.applications.interchain_accounts.host.v1.QueryRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.ibc.applications.interchain_accounts.host.v1.QueryRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.ibc.applications.interchain_accounts.host.v1.QueryRequest;
  return proto.ibc.applications.interchain_accounts.host.v1.QueryRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.ibc.applications.interchain_accounts.host.v1.QueryRequest}
 */
proto.ibc.applications.interchain_accounts.host.v1.QueryRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.ibc.applications.interchain_accounts.host.v1.QueryRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.ibc.applications.interchain_accounts.host.v1.QueryRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ibc.applications.interchain_accounts.host.v1.QueryRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPath();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.ibc.applications.interchain_accounts.host.v1.QueryRequest.prototype.getPath = function() {
 ...
 */
proto.ibc.applications.interchain_accounts.host.v1.QueryRequest.prototype.setPath = function(value) {
 ...
 */
proto.ibc.applications.interchain_accounts.host.v1.QueryRequest.prototype.getData = function() {
 ...
 * @return {string}
 */
proto.ibc.applications.interchain_accounts.host.v1.QueryRequest.prototype.getData_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.ibc.applications.interchain_accounts.host.v1.QueryRequest.prototype.getData_asU8 = function() {
 ...
 * @return {!proto.ibc.applications.interchain_accounts.host.v1.QueryRequest} returns this
 */
proto.ibc.applications.interchain_accounts.host.v1.QueryRequest.prototype.setData = function(value) {
