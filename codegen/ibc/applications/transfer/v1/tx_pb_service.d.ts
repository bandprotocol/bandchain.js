...
type MsgUpdateParams = {
  ...
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof ibc_applications_transfer_v1_tx_pb.MsgUpdateParams;
  readonly responseType: typeof ibc_applications_transfer_v1_tx_pb.MsgUpdateParamsResponse;
};
...
export class MsgClient {
  ...
  updateParams(
    requestMessage: ibc_applications_transfer_v1_tx_pb.MsgUpdateParams,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: ibc_applications_transfer_v1_tx_pb.MsgUpdateParamsResponse|null) => void
  ): UnaryResponse;
  updateParams(
    requestMessage: ibc_applications_transfer_v1_tx_pb.MsgUpdateParams,
    callback: (error: ServiceError|null, responseMessage: ibc_applications_transfer_v1_tx_pb.MsgUpdateParamsResponse|null) => void
