...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.mint.v1beta1.GenesisState.displayName =
    'proto.cosmos.mint.v1beta1.GenesisState'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.mint.v1beta1.GenesisState.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.mint.v1beta1.GenesisState.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.cosmos.mint.v1beta1.GenesisState.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
      obj = {
        minter:
          (f = msg.getMinter()) &&
          cosmos_mint_v1beta1_mint_pb.Minter.toObject(includeInstance, f),
        params:
          (f = msg.getParams()) &&
...
proto.cosmos.mint.v1beta1.GenesisState.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.mint.v1beta1.GenesisState.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.mint.v1beta1.GenesisState}
 */
proto.cosmos.mint.v1beta1.GenesisState.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          cosmos_mint_v1beta1_mint_pb.Minter.deserializeBinaryFromReader,
        )
        msg.setMinter(value)
        break
      case 2:
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.mint.v1beta1.GenesisState.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
