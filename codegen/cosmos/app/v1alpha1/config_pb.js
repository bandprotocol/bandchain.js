...
proto.cosmos.app.v1alpha1.Config = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.cosmos.app.v1alpha1.Config.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.app.v1alpha1.Config.displayName =
    'proto.cosmos.app.v1alpha1.Config'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.cosmos.app.v1alpha1.ModuleConfig = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.cosmos.app.v1alpha1.ModuleConfig.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.app.v1alpha1.ModuleConfig.displayName =
    'proto.cosmos.app.v1alpha1.ModuleConfig'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.app.v1alpha1.GolangBinding.displayName =
    'proto.cosmos.app.v1alpha1.GolangBinding'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.app.v1alpha1.Config.prototype.toObject = function (
    opt_includeInstance,
  ) {
  ...
  proto.cosmos.app.v1alpha1.Config.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        modulesList: jspb.Message.toObjectList(
          msg.getModulesList(),
          proto.cosmos.app.v1alpha1.ModuleConfig.toObject,
          includeInstance,
        ),
        golangBindingsList: jspb.Message.toObjectList(
          msg.getGolangBindingsList(),
          proto.cosmos.app.v1alpha1.GolangBinding.toObject,
          includeInstance,
        ),
      }
...
proto.cosmos.app.v1alpha1.Config.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.app.v1alpha1.Config.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.app.v1alpha1.Config}
 */
proto.cosmos.app.v1alpha1.Config.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.cosmos.app.v1alpha1.ModuleConfig.deserializeBinaryFromReader,
        )
      ...
      case 2:
        ...
        reader.readMessage(
          value,
          proto.cosmos.app.v1alpha1.GolangBinding.deserializeBinaryFromReader,
        )
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.app.v1alpha1.Config.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.cosmos.app.v1alpha1.Config.prototype.addModules = function (
  opt_value,
  opt_index,
) {
 ...
 * @return {!proto.cosmos.app.v1alpha1.Config} returns this
 */
proto.cosmos.app.v1alpha1.Config.prototype.setGolangBindingsList = function (
  value,
) {
 ...
 */
proto.cosmos.app.v1alpha1.Config.prototype.addGolangBindings = function (
  opt_value,
  opt_index,
) {
  return jspb.Message.addToRepeatedWrapperField(
 ...
 * @return {!proto.cosmos.app.v1alpha1.Config} returns this
 */
proto.cosmos.app.v1alpha1.Config.prototype.clearGolangBindingsList =
  function () {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.app.v1alpha1.ModuleConfig.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.app.v1alpha1.ModuleConfig.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.cosmos.app.v1alpha1.ModuleConfig.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.cosmos.app.v1alpha1.ModuleConfig.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.app.v1alpha1.ModuleConfig.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.app.v1alpha1.ModuleConfig}
 */
proto.cosmos.app.v1alpha1.ModuleConfig.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.app.v1alpha1.ModuleConfig.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 * @return {!Array<!proto.cosmos.app.v1alpha1.GolangBinding>}
 */
proto.cosmos.app.v1alpha1.ModuleConfig.prototype.getGolangBindingsList =
  function () {
    return /** @type{!Array<!proto.cosmos.app.v1alpha1.GolangBinding>} */ (
      jspb.Message.getRepeatedWrapperField(
        this,
 ...
 * @return {!proto.cosmos.app.v1alpha1.ModuleConfig} returns this
 */
proto.cosmos.app.v1alpha1.ModuleConfig.prototype.setGolangBindingsList =
  function (value) {
 ...
 * @return {!proto.cosmos.app.v1alpha1.GolangBinding}
 */
proto.cosmos.app.v1alpha1.ModuleConfig.prototype.addGolangBindings = function (
  opt_value,
  opt_index,
) {
  return jspb.Message.addToRepeatedWrapperField(
 ...
 * @return {!proto.cosmos.app.v1alpha1.ModuleConfig} returns this
 */
proto.cosmos.app.v1alpha1.ModuleConfig.prototype.clearGolangBindingsList =
  function () {
    return this.setGolangBindingsList([])
  }
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.app.v1alpha1.GolangBinding.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.app.v1alpha1.GolangBinding.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.cosmos.app.v1alpha1.GolangBinding.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.cosmos.app.v1alpha1.GolangBinding.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.app.v1alpha1.GolangBinding.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.app.v1alpha1.GolangBinding}
 */
proto.cosmos.app.v1alpha1.GolangBinding.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @return {!Uint8Array}
 */
proto.cosmos.app.v1alpha1.GolangBinding.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
    proto.cosmos.app.v1alpha1.GolangBinding.serializeBinaryToWriter(
      this,
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.app.v1alpha1.GolangBinding.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 * @return {string}
 */
proto.cosmos.app.v1alpha1.GolangBinding.prototype.getInterfaceType =
  function () {
    return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ''))
  }
 ...
 */
proto.cosmos.app.v1alpha1.GolangBinding.prototype.setInterfaceType = function (
  value,
) {
  return jspb.Message.setProto3StringField(this, 1, value)
}
 ...
 * @return {string}
 */
proto.cosmos.app.v1alpha1.GolangBinding.prototype.getImplementation =
  function () {
 ...
 * @return {!proto.cosmos.app.v1alpha1.GolangBinding} returns this
 */
proto.cosmos.app.v1alpha1.GolangBinding.prototype.setImplementation = function (
  value,
) {
