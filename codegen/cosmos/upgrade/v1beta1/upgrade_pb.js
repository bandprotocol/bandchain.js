...
goog.exportSymbol(
  'proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal',
  null,
  global,
)
...
goog.exportSymbol(
  'proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal',
  null,
  global,
)
/**
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.upgrade.v1beta1.Plan.displayName =
    'proto.cosmos.upgrade.v1beta1.Plan'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.displayName =
    'proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal'
}
/**
 * Generated by JsPbCodeGenerator.
 ...
 * @constructor
 */
proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal = function (
  opt_data,
) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null)
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal.displayName =
    'proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal'
}
/**
 * Generated by JsPbCodeGenerator.
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.upgrade.v1beta1.ModuleVersion.displayName =
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.upgrade.v1beta1.Plan.prototype.toObject = function (
    opt_includeInstance,
  ) {
...
proto.cosmos.upgrade.v1beta1.Plan.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.upgrade.v1beta1.Plan.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.upgrade.v1beta1.Plan}
 */
proto.cosmos.upgrade.v1beta1.Plan.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.upgrade.v1beta1.Plan.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.cosmos.upgrade.v1beta1.Plan.prototype.getUpgradedClientState =
  function () {
 ...
 * @return {!proto.cosmos.upgrade.v1beta1.Plan} returns this
 */
proto.cosmos.upgrade.v1beta1.Plan.prototype.setUpgradedClientState = function (
  value,
) {
 ...
 * @return {!proto.cosmos.upgrade.v1beta1.Plan} returns this
 */
proto.cosmos.upgrade.v1beta1.Plan.prototype.clearUpgradedClientState =
  function () {
 ...
 * @return {boolean}
 */
proto.cosmos.upgrade.v1beta1.Plan.prototype.hasUpgradedClientState =
  function () {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.prototype.toObject =
    function (opt_includeInstance) {
      return proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.toObject(
        opt_includeInstance,
        this,
      )
    }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
      obj = {
        ...
        plan:
          (f = msg.getPlan()) &&
          proto.cosmos.upgrade.v1beta1.Plan.toObject(includeInstance, f),
      }
 ...
 */
proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.deserializeBinary =
  function (bytes) {
    var reader = new jspb.BinaryReader(bytes)
    var msg = new proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal()
    return proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.deserializeBinaryFromReader(
      msg,
      reader,
    )
  }
 ...
 * @return {!proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal}
 */
proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break
      ...
      switch (field) {
        ...
        case 3:
          ...
          reader.readMessage(
            value,
            proto.cosmos.upgrade.v1beta1.Plan.deserializeBinaryFromReader,
          )
          msg.setPlan(value)
          break
        default:
 ...
 * @return {!Uint8Array}
 */
proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
    proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.serializeBinaryToWriter(
      this,
      writer,
    )
    return writer.getResultBuffer()
 ...
 * @return {string}
 */
proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.prototype.getTitle =
  function () {
    return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ''))
  }
 ...
 */
proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.prototype.setTitle =
  function (value) {
    return jspb.Message.setProto3StringField(this, 1, value)
  }
 ...
 * @return {string}
 */
proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.prototype.getDescription =
  function () {
 ...
 * @return {!proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal} returns this
 */
proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.prototype.setDescription =
  function (value) {
 ...
 * @return {?proto.cosmos.upgrade.v1beta1.Plan}
 */
proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.prototype.getPlan =
  function () {
 ...
 * @return {!proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal} returns this
 */
proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.prototype.setPlan =
  function (value) {
 ...
 * @return {!proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal} returns this
 */
proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.prototype.clearPlan =
  function () {
 ...
 * @return {boolean}
 */
proto.cosmos.upgrade.v1beta1.SoftwareUpgradeProposal.prototype.hasPlan =
  function () {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal.prototype.toObject =
    function (opt_includeInstance) {
      return proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal.toObject(
        opt_includeInstance,
        this,
      )
    }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal.toObject =
 ...
 */
proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal.deserializeBinary =
  function (bytes) {
    var reader = new jspb.BinaryReader(bytes)
    var msg = new proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal()
    return proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal.deserializeBinaryFromReader(
      msg,
      reader,
    )
  }
 ...
 * @return {!proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal}
 */
proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break
 ...
 * @return {!Uint8Array}
 */
proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
    proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal.serializeBinaryToWriter(
      this,
      writer,
    )
    return writer.getResultBuffer()
 ...
 * @return {string}
 */
proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal.prototype.getTitle =
  function () {
    return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ''))
  }
 ...
 */
proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal.prototype.setTitle =
  function (value) {
    return jspb.Message.setProto3StringField(this, 1, value)
  }
 ...
 * @return {string}
 */
proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal.prototype.getDescription =
  function () {
    return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ''))
  }
 ...
 * @return {!proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal} returns this
 */
proto.cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal.prototype.setDescription =
  function (value) {
    return jspb.Message.setProto3StringField(this, 2, value)
  }
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.upgrade.v1beta1.ModuleVersion.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.upgrade.v1beta1.ModuleVersion.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.cosmos.upgrade.v1beta1.ModuleVersion.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
 ...
 */
proto.cosmos.upgrade.v1beta1.ModuleVersion.deserializeBinary = function (
  bytes,
) {
  var reader = new jspb.BinaryReader(bytes)
  var msg = new proto.cosmos.upgrade.v1beta1.ModuleVersion()
  return proto.cosmos.upgrade.v1beta1.ModuleVersion.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.upgrade.v1beta1.ModuleVersion}
 */
proto.cosmos.upgrade.v1beta1.ModuleVersion.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break
 ...
 * @return {!Uint8Array}
 */
proto.cosmos.upgrade.v1beta1.ModuleVersion.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.upgrade.v1beta1.ModuleVersion.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.cosmos.upgrade.v1beta1.ModuleVersion.prototype.setName = function (
  value,
) {
  return jspb.Message.setProto3StringField(this, 1, value)
}
 ...
 * @return {!proto.cosmos.upgrade.v1beta1.ModuleVersion} returns this
 */
proto.cosmos.upgrade.v1beta1.ModuleVersion.prototype.setVersion = function (
  value,
) {
