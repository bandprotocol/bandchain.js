...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.capability.module.v1.Module.displayName =
    'proto.cosmos.capability.module.v1.Module'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.capability.module.v1.Module.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.capability.module.v1.Module.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.cosmos.capability.module.v1.Module.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.cosmos.capability.module.v1.Module.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.capability.module.v1.Module.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.capability.module.v1.Module}
 */
proto.cosmos.capability.module.v1.Module.deserializeBinaryFromReader =
  function (msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.cosmos.capability.module.v1.Module.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
    proto.cosmos.capability.module.v1.Module.serializeBinaryToWriter(
      this,
      writer,
    )
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.capability.module.v1.Module.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.cosmos.capability.module.v1.Module.prototype.setSealKeeper = function (
  value,
) {
