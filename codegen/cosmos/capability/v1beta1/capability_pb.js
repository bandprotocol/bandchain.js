...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.capability.v1beta1.Capability.displayName =
    'proto.cosmos.capability.v1beta1.Capability'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.capability.v1beta1.Owner.displayName =
    'proto.cosmos.capability.v1beta1.Owner'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.cosmos.capability.v1beta1.CapabilityOwners = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.cosmos.capability.v1beta1.CapabilityOwners.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.capability.v1beta1.CapabilityOwners.displayName =
    'proto.cosmos.capability.v1beta1.CapabilityOwners'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.capability.v1beta1.Capability.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.capability.v1beta1.Capability.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.cosmos.capability.v1beta1.Capability.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
 ...
 */
proto.cosmos.capability.v1beta1.Capability.deserializeBinary = function (
  bytes,
) {
  var reader = new jspb.BinaryReader(bytes)
  var msg = new proto.cosmos.capability.v1beta1.Capability()
  return proto.cosmos.capability.v1beta1.Capability.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.capability.v1beta1.Capability}
 */
proto.cosmos.capability.v1beta1.Capability.deserializeBinaryFromReader =
  function (msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.cosmos.capability.v1beta1.Capability.prototype.serializeBinary =
  function () {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.capability.v1beta1.Capability.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.cosmos.capability.v1beta1.Capability.prototype.setIndex = function (
  value,
) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.capability.v1beta1.Owner.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.capability.v1beta1.Owner.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.cosmos.capability.v1beta1.Owner.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.cosmos.capability.v1beta1.Owner.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.capability.v1beta1.Owner.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.capability.v1beta1.Owner}
 */
proto.cosmos.capability.v1beta1.Owner.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.capability.v1beta1.Owner.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.capability.v1beta1.CapabilityOwners.prototype.toObject =
    function (opt_includeInstance) {
      return proto.cosmos.capability.v1beta1.CapabilityOwners.toObject(
        opt_includeInstance,
        this,
      )
    }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.cosmos.capability.v1beta1.CapabilityOwners.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
      obj = {
        ownersList: jspb.Message.toObjectList(
          msg.getOwnersList(),
          proto.cosmos.capability.v1beta1.Owner.toObject,
          includeInstance,
        ),
      }
 ...
 */
proto.cosmos.capability.v1beta1.CapabilityOwners.deserializeBinary = function (
  bytes,
) {
  var reader = new jspb.BinaryReader(bytes)
  var msg = new proto.cosmos.capability.v1beta1.CapabilityOwners()
  return proto.cosmos.capability.v1beta1.CapabilityOwners.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.capability.v1beta1.CapabilityOwners}
 */
proto.cosmos.capability.v1beta1.CapabilityOwners.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break
      ...
      switch (field) {
        case 1:
          ...
          reader.readMessage(
            value,
            proto.cosmos.capability.v1beta1.Owner.deserializeBinaryFromReader,
          )
          msg.addOwners(value)
          break
        default:
 ...
 * @return {!Uint8Array}
 */
proto.cosmos.capability.v1beta1.CapabilityOwners.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
 ...
 */
proto.cosmos.capability.v1beta1.CapabilityOwners.prototype.getOwnersList =
  function () {
 ...
 */
proto.cosmos.capability.v1beta1.CapabilityOwners.prototype.setOwnersList =
  function (value) {
 ...
 * @return {!proto.cosmos.capability.v1beta1.Owner}
 */
proto.cosmos.capability.v1beta1.CapabilityOwners.prototype.addOwners =
 ...
 * @return {!proto.cosmos.capability.v1beta1.CapabilityOwners} returns this
 */
proto.cosmos.capability.v1beta1.CapabilityOwners.prototype.clearOwnersList =
  function () {
