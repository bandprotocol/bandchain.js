    ...
    export class ServiceCommandDescriptor extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("enhance_custom_command" in data && data.enhance_custom_command != undefined) {
                    this.enhance_custom_command = data.enhance_custom_command;
                }
        ...
        get enhance_custom_command() {
            return pb_1.Message.getFieldWithDefault(this, 4, false) as boolean;
        }
        set enhance_custom_command(value: boolean) {
        ...
        static fromObject(data: {
            ...
            if (data.enhance_custom_command != null) {
                message.enhance_custom_command = data.enhance_custom_command;
            }
            if (data.short != null) {
        ...
        toObject() {
            ...
            if (this.enhance_custom_command != null) {
                data.enhance_custom_command = this.enhance_custom_command;
            }
            if (this.short != null) {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.enhance_custom_command != false)
                writer.writeBool(4, this.enhance_custom_command);
            if (this.short.length)
                writer.writeString(5, this.short);
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        message.enhance_custom_command = reader.readBool();
                        break;
                    case 5:
    ...
    export class RpcCommandOptions extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("gov_proposal" in data && data.gov_proposal != undefined) {
                    this.gov_proposal = data.gov_proposal;
                }
            }
        ...
        set gov_proposal(value: boolean) {
        ...
        static fromObject(data: {
            ...
            if (data.gov_proposal != null) {
                message.gov_proposal = data.gov_proposal;
            }
            return message;
        }
        toObject() {
            ...
            if (this.gov_proposal != null) {
                data.gov_proposal = this.gov_proposal;
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.gov_proposal != false)
                writer.writeBool(13, this.gov_proposal);
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 12:
                        ...
                        break;
                    case 13:
                        message.gov_proposal = reader.readBool();
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class PositionalArgDescriptor extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.optional != false)
                writer.writeBool(3, this.optional);
            if (!w)
                return writer.getResultBuffer();
        }
