...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.consensus.v1.MsgUpdateParams.displayName =
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.consensus.v1.MsgUpdateParamsResponse.displayName =
    'proto.cosmos.consensus.v1.MsgUpdateParamsResponse'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.consensus.v1.MsgUpdateParams.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.consensus.v1.MsgUpdateParams.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.cosmos.consensus.v1.MsgUpdateParams.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
      obj = {
        ...
        block:
          (f = msg.getBlock()) &&
          tendermint_types_params_pb.BlockParams.toObject(includeInstance, f),
        evidence:
          (f = msg.getEvidence()) &&
          tendermint_types_params_pb.EvidenceParams.toObject(
            includeInstance,
            f,
          ),
        validator:
          (f = msg.getValidator()) &&
          tendermint_types_params_pb.ValidatorParams.toObject(
            includeInstance,
            f,
          ),
      }
...
proto.cosmos.consensus.v1.MsgUpdateParams.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.consensus.v1.MsgUpdateParams.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.consensus.v1.MsgUpdateParams}
 */
proto.cosmos.consensus.v1.MsgUpdateParams.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      ...
      switch (field) {
        ...
        case 2:
          ...
          reader.readMessage(
            value,
            tendermint_types_params_pb.BlockParams.deserializeBinaryFromReader,
          )
          msg.setBlock(value)
          break
        case 3:
          ...
          reader.readMessage(
            value,
            tendermint_types_params_pb.EvidenceParams
        ...
        case 4:
          ...
          reader.readMessage(
            value,
            tendermint_types_params_pb.ValidatorParams
              .deserializeBinaryFromReader,
          )
 ...
 * @return {!Uint8Array}
 */
proto.cosmos.consensus.v1.MsgUpdateParams.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
    proto.cosmos.consensus.v1.MsgUpdateParams.serializeBinaryToWriter(
      this,
      writer,
    )
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.consensus.v1.MsgUpdateParams.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.cosmos.consensus.v1.MsgUpdateParams.prototype.setAuthority = function (
  value,
) {
...
proto.cosmos.consensus.v1.MsgUpdateParams.prototype.getBlock = function () {
  return /** @type{?proto.tendermint.types.BlockParams} */ (
    jspb.Message.getWrapperField(
      this,
      tendermint_types_params_pb.BlockParams,
      2,
    )
  )
}
 ...
 * @return {!proto.cosmos.consensus.v1.MsgUpdateParams} returns this
 */
proto.cosmos.consensus.v1.MsgUpdateParams.prototype.setBlock = function (
  value,
) {
 ...
 * @return {!proto.cosmos.consensus.v1.MsgUpdateParams} returns this
 */
proto.cosmos.consensus.v1.MsgUpdateParams.prototype.setEvidence = function (
  value,
) {
 ...
 * @return {!proto.cosmos.consensus.v1.MsgUpdateParams} returns this
 */
proto.cosmos.consensus.v1.MsgUpdateParams.prototype.clearEvidence =
  function () {
 ...
 * @return {!proto.cosmos.consensus.v1.MsgUpdateParams} returns this
 */
proto.cosmos.consensus.v1.MsgUpdateParams.prototype.setValidator = function (
  value,
) {
 ...
 * @return {!proto.cosmos.consensus.v1.MsgUpdateParams} returns this
 */
proto.cosmos.consensus.v1.MsgUpdateParams.prototype.clearValidator =
  function () {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.consensus.v1.MsgUpdateParamsResponse.prototype.toObject =
    function (opt_includeInstance) {
      return proto.cosmos.consensus.v1.MsgUpdateParamsResponse.toObject(
        opt_includeInstance,
        this,
      )
    }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.cosmos.consensus.v1.MsgUpdateParamsResponse.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
 ...
 */
proto.cosmos.consensus.v1.MsgUpdateParamsResponse.deserializeBinary = function (
  bytes,
) {
  var reader = new jspb.BinaryReader(bytes)
  var msg = new proto.cosmos.consensus.v1.MsgUpdateParamsResponse()
  return proto.cosmos.consensus.v1.MsgUpdateParamsResponse.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.consensus.v1.MsgUpdateParamsResponse}
 */
proto.cosmos.consensus.v1.MsgUpdateParamsResponse.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break
 ...
 * @return {!Uint8Array}
 */
proto.cosmos.consensus.v1.MsgUpdateParamsResponse.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
    proto.cosmos.consensus.v1.MsgUpdateParamsResponse.serializeBinaryToWriter(
      this,
      writer,
    )
    return writer.getResultBuffer()
