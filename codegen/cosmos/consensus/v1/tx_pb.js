...
proto.cosmos.consensus.v1.MsgUpdateParams.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    abci: (f = msg.getAbci()) && tendermint_types_params_pb.ABCIParams.toObject(includeInstance, f)
  };
...
proto.cosmos.consensus.v1.MsgUpdateParams.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new tendermint_types_params_pb.ABCIParams;
      reader.readMessage(value,tendermint_types_params_pb.ABCIParams.deserializeBinaryFromReader);
      msg.setAbci(value);
      break;
    default:
      reader.skipField();
...
proto.cosmos.consensus.v1.MsgUpdateParams.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      tendermint_types_params_pb.ABCIParams.serializeBinaryToWriter
    );
  }
};
...
proto.cosmos.consensus.v1.MsgUpdateParams.prototype.getAbci = function() {
  return /** @type{?proto.tendermint.types.ABCIParams} */ (
    jspb.Message.getWrapperField(this, tendermint_types_params_pb.ABCIParams, 5));
};
