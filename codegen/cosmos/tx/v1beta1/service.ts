...
import * as dependency_5 from "./../../../cometbft/types/v1/block";
import * as dependency_6 from "./../../../cometbft/types/v1/types";
...
export namespace cosmos.tx.v1beta1 {
    ...
    export class GetBlockWithTxsResponse extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            txs?: dependency_3.cosmos.tx.v1beta1.Tx[];
            block_id?: dependency_6.cometbft.types.v1.BlockID;
            block?: dependency_5.cometbft.types.v1.Block;
            pagination?: dependency_4.cosmos.base.query.v1beta1.PageResponse;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], this.#one_of_decls);
        ...
        get block_id() {
            return pb_1.Message.getWrapperField(this, dependency_6.cometbft.types.v1.BlockID, 2) as dependency_6.cometbft.types.v1.BlockID;
        }
        set block_id(value: dependency_6.cometbft.types.v1.BlockID) {
            pb_1.Message.setWrapperField(this, 2, value);
        }
        get has_block_id() {
            return pb_1.Message.getField(this, 2) != null;
        ...
        get block() {
            return pb_1.Message.getWrapperField(this, dependency_5.cometbft.types.v1.Block, 3) as dependency_5.cometbft.types.v1.Block;
        }
        set block(value: dependency_5.cometbft.types.v1.Block) {
            pb_1.Message.setWrapperField(this, 3, value);
        }
        get has_block() {
            return pb_1.Message.getField(this, 3) != null;
        ...
        static fromObject(data: {
            txs?: ReturnType<typeof dependency_3.cosmos.tx.v1beta1.Tx.prototype.toObject>[];
            block_id?: ReturnType<typeof dependency_6.cometbft.types.v1.BlockID.prototype.toObject>;
            block?: ReturnType<typeof dependency_5.cometbft.types.v1.Block.prototype.toObject>;
            pagination?: ReturnType<typeof dependency_4.cosmos.base.query.v1beta1.PageResponse.prototype.toObject>;
            ...
            if (data.block_id != null) {
                message.block_id = dependency_6.cometbft.types.v1.BlockID.fromObject(data.block_id);
            }
            if (data.block != null) {
                message.block = dependency_5.cometbft.types.v1.Block.fromObject(data.block);
            }
            if (data.pagination != null) {
                message.pagination = dependency_4.cosmos.base.query.v1beta1.PageResponse.fromObject(data.pagination);
            }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.block_id, () => message.block_id = dependency_6.cometbft.types.v1.BlockID.deserialize(reader));
                        break;
                    case 3:
                        reader.readMessage(message.block, () => message.block = dependency_5.cometbft.types.v1.Block.deserialize(reader));
                        break;
                    case 4:
                        reader.readMessage(message.pagination, () => message.pagination = dependency_4.cosmos.base.query.v1beta1.PageResponse.deserialize(reader));
                        break;
