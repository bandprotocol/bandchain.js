...
proto.cosmos.feegrant.v1beta1.GenesisState = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.cosmos.feegrant.v1beta1.GenesisState.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.feegrant.v1beta1.GenesisState.displayName =
    'proto.cosmos.feegrant.v1beta1.GenesisState'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.feegrant.v1beta1.GenesisState.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.feegrant.v1beta1.GenesisState.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.cosmos.feegrant.v1beta1.GenesisState.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
 ...
 */
proto.cosmos.feegrant.v1beta1.GenesisState.deserializeBinary = function (
  bytes,
) {
  var reader = new jspb.BinaryReader(bytes)
  var msg = new proto.cosmos.feegrant.v1beta1.GenesisState()
  return proto.cosmos.feegrant.v1beta1.GenesisState.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.feegrant.v1beta1.GenesisState}
 */
proto.cosmos.feegrant.v1beta1.GenesisState.deserializeBinaryFromReader =
  function (msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.cosmos.feegrant.v1beta1.GenesisState.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
    proto.cosmos.feegrant.v1beta1.GenesisState.serializeBinaryToWriter(
      this,
      writer,
    )
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.feegrant.v1beta1.GenesisState.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.cosmos.feegrant.v1beta1.GenesisState.prototype.getAllowancesList =
  function () {
 ...
 */
proto.cosmos.feegrant.v1beta1.GenesisState.prototype.setAllowancesList =
  function (value) {
 ...
 */
proto.cosmos.feegrant.v1beta1.GenesisState.prototype.addAllowances = function (
  opt_value,
  opt_index,
) {
 ...
 * @return {!proto.cosmos.feegrant.v1beta1.GenesisState} returns this
 */
proto.cosmos.feegrant.v1beta1.GenesisState.prototype.clearAllowancesList =
  function () {
