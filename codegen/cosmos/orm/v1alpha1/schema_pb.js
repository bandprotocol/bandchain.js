...
goog.exportSymbol(
  'proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry',
  null,
  global,
)
...
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.displayName =
    'proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor'
}
/**
 * Generated by JsPbCodeGenerator.
 ...
 * @constructor
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry = function (
  opt_data,
) {
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.displayName =
    'proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.prototype.toObject =
    function (opt_includeInstance) {
      return proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.toObject(
        opt_includeInstance,
        this,
      )
    }
   ...
   */
  proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
      obj = {
        schemaFileList: jspb.Message.toObjectList(
          msg.getSchemaFileList(),
          proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.toObject,
          includeInstance,
        ),
 ...
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.deserializeBinary = function (
  bytes,
) {
  var reader = new jspb.BinaryReader(bytes)
  var msg = new proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor()
  return proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
  ...
  function (msg, reader) {
    while (reader.nextField()) {
      ...
      switch (field) {
        case 1:
          var value =
            new proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry()
          reader.readMessage(
            value,
            proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry
 ...
 * @return {!Uint8Array}
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.prototype.serializeBinary =
  function () {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.prototype.toObject =
    function (opt_includeInstance) {
      return proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.toObject(
        opt_includeInstance,
        this,
      )
    }
 ...
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.deserializeBinary =
  function (bytes) {
    var reader = new jspb.BinaryReader(bytes)
    var msg = new proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry()
    return proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.deserializeBinaryFromReader(
      msg,
      reader,
    )
  }
 ...
 * @return {!proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry}
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break
      ...
      switch (field) {
        ...
        case 2:
          ...
          break
        case 3:
          var value = /** @type {!proto.cosmos.orm.v1alpha1.StorageType} */ (
            reader.readEnum()
          )
 ...
 * @return {!Uint8Array}
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
 ...
 * @return {number}
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.prototype.getId =
  function () {
 ...
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.prototype.setId =
  function (value) {
 ...
 * @return {string}
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.prototype.getProtoFileName =
  function () {
 ...
 * @return {!proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry} returns this
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.prototype.setProtoFileName =
  function (value) {
 ...
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.prototype.getStorageType =
  function () {
    return /** @type {!proto.cosmos.orm.v1alpha1.StorageType} */ (
 ...
 * @return {!proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry} returns this
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.prototype.setStorageType =
  function (value) {
 ...
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.prototype.getSchemaFileList =
  function () {
 ...
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.prototype.setSchemaFileList =
  function (value) {
 ...
 * @return {!proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry}
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.prototype.addSchemaFile =
 ...
 * @return {!proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor} returns this
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.prototype.clearSchemaFileList =
  function () {
 ...
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.prototype.getPrefix =
  function () {
 ...
 * @return {string}
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.prototype.getPrefix_asB64 =
  function () {
 ...
 * @return {!Uint8Array}
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.prototype.getPrefix_asU8 =
  function () {
 ...
 * @return {!proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor} returns this
 */
proto.cosmos.orm.v1alpha1.ModuleSchemaDescriptor.prototype.setPrefix =
  function (value) {
...
google_protobuf_descriptor_pb.MessageOptions.extensionsBinary[104503792] =
...
google_protobuf_descriptor_pb.MessageOptions.extensions[104503792] =
  proto.cosmos.orm.v1alpha1.moduleSchema
