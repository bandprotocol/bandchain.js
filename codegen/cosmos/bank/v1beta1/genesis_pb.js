...
proto.cosmos.bank.v1beta1.GenesisState = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.cosmos.bank.v1beta1.GenesisState.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.bank.v1beta1.GenesisState.displayName =
    'proto.cosmos.bank.v1beta1.GenesisState'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.cosmos.bank.v1beta1.Balance = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.cosmos.bank.v1beta1.Balance.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.bank.v1beta1.Balance.displayName =
    'proto.cosmos.bank.v1beta1.Balance'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.bank.v1beta1.GenesisState.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.bank.v1beta1.GenesisState.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.cosmos.bank.v1beta1.GenesisState.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
      obj = {
        ...
        balancesList: jspb.Message.toObjectList(
          msg.getBalancesList(),
          proto.cosmos.bank.v1beta1.Balance.toObject,
          includeInstance,
        ),
        ...
        denomMetadataList: jspb.Message.toObjectList(
          msg.getDenomMetadataList(),
...
proto.cosmos.bank.v1beta1.GenesisState.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.bank.v1beta1.GenesisState.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.bank.v1beta1.GenesisState}
 */
proto.cosmos.bank.v1beta1.GenesisState.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 2:
        ...
        reader.readMessage(
          value,
          proto.cosmos.bank.v1beta1.Balance.deserializeBinaryFromReader,
        )
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.bank.v1beta1.GenesisState.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 * @return {!proto.cosmos.bank.v1beta1.GenesisState} returns this
 */
proto.cosmos.bank.v1beta1.GenesisState.prototype.setBalancesList = function (
  value,
) {
 ...
 */
proto.cosmos.bank.v1beta1.GenesisState.prototype.addBalances = function (
  opt_value,
  opt_index,
) {
 ...
 * @return {!proto.cosmos.bank.v1beta1.GenesisState} returns this
 */
proto.cosmos.bank.v1beta1.GenesisState.prototype.clearBalancesList =
  function () {
 ...
 * @return {!proto.cosmos.bank.v1beta1.GenesisState} returns this
 */
proto.cosmos.bank.v1beta1.GenesisState.prototype.setSupplyList = function (
  value,
) {
 ...
 */
proto.cosmos.bank.v1beta1.GenesisState.prototype.addSupply = function (
  opt_value,
  opt_index,
) {
  return jspb.Message.addToRepeatedWrapperField(
 ...
 */
proto.cosmos.bank.v1beta1.GenesisState.prototype.getDenomMetadataList =
  function () {
 ...
 * @return {!proto.cosmos.bank.v1beta1.GenesisState} returns this
 */
proto.cosmos.bank.v1beta1.GenesisState.prototype.setDenomMetadataList =
  function (value) {
 ...
 */
proto.cosmos.bank.v1beta1.GenesisState.prototype.addDenomMetadata = function (
  opt_value,
  opt_index,
) {
  return jspb.Message.addToRepeatedWrapperField(
 ...
 * @return {!proto.cosmos.bank.v1beta1.GenesisState} returns this
 */
proto.cosmos.bank.v1beta1.GenesisState.prototype.clearDenomMetadataList =
  function () {
 ...
 */
proto.cosmos.bank.v1beta1.GenesisState.prototype.getSendEnabledList =
  function () {
 ...
 * @return {!proto.cosmos.bank.v1beta1.GenesisState} returns this
 */
proto.cosmos.bank.v1beta1.GenesisState.prototype.setSendEnabledList = function (
  value,
) {
 ...
 */
proto.cosmos.bank.v1beta1.GenesisState.prototype.addSendEnabled = function (
  opt_value,
  opt_index,
) {
  return jspb.Message.addToRepeatedWrapperField(
 ...
 * @return {!proto.cosmos.bank.v1beta1.GenesisState} returns this
 */
proto.cosmos.bank.v1beta1.GenesisState.prototype.clearSendEnabledList =
  function () {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.bank.v1beta1.Balance.prototype.toObject = function (
    opt_includeInstance,
  ) {
...
proto.cosmos.bank.v1beta1.Balance.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.bank.v1beta1.Balance.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.bank.v1beta1.Balance}
 */
proto.cosmos.bank.v1beta1.Balance.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.bank.v1beta1.Balance.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 * @return {!proto.cosmos.base.v1beta1.Coin}
 */
proto.cosmos.bank.v1beta1.Balance.prototype.addCoins = function (
  opt_value,
  opt_index,
) {
  return jspb.Message.addToRepeatedWrapperField(
