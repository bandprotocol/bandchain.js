 ...
 * @const
 */
proto.cosmos.bank.module.v1.Module.repeatedFields_ = [1,3];
...
proto.cosmos.bank.module.v1.Module.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    restrictionsOrderList: (f = jspb.Message.getRepeatedField(msg, 3)) == null ? undefined : f
  };
...
proto.cosmos.bank.module.v1.Module.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      var value = /** @type {string} */ (reader.readString());
      msg.addRestrictionsOrder(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.cosmos.bank.module.v1.Module.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getRestrictionsOrderList();
  if (f.length > 0) {
    writer.writeRepeatedString(
      3,
      f
 ...
 * @return {!Array<string>}
 */
proto.cosmos.bank.module.v1.Module.prototype.getRestrictionsOrderList = function() {
 ...
 * @return {!proto.cosmos.bank.module.v1.Module} returns this
 */
proto.cosmos.bank.module.v1.Module.prototype.setRestrictionsOrderList = function(value) {
 ...
 * @return {!proto.cosmos.bank.module.v1.Module} returns this
 */
proto.cosmos.bank.module.v1.Module.prototype.addRestrictionsOrder = function(value, opt_index) {
 ...
 * @return {!proto.cosmos.bank.module.v1.Module} returns this
 */
proto.cosmos.bank.module.v1.Module.prototype.clearRestrictionsOrderList = function() {
  return this.setRestrictionsOrderList([]);
};
