...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.nft.v1beta1.EventSend.displayName =
    'proto.cosmos.nft.v1beta1.EventSend'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.nft.v1beta1.EventMint.displayName =
    'proto.cosmos.nft.v1beta1.EventMint'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.nft.v1beta1.EventBurn.displayName =
    'proto.cosmos.nft.v1beta1.EventBurn'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.nft.v1beta1.EventSend.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.nft.v1beta1.EventSend.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.cosmos.nft.v1beta1.EventSend.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.cosmos.nft.v1beta1.EventSend.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.nft.v1beta1.EventSend.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.nft.v1beta1.EventSend}
 */
proto.cosmos.nft.v1beta1.EventSend.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.nft.v1beta1.EventSend.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.nft.v1beta1.EventMint.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.nft.v1beta1.EventMint.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.cosmos.nft.v1beta1.EventMint.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.cosmos.nft.v1beta1.EventMint.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.nft.v1beta1.EventMint.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.nft.v1beta1.EventMint}
 */
proto.cosmos.nft.v1beta1.EventMint.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.nft.v1beta1.EventMint.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.nft.v1beta1.EventBurn.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.nft.v1beta1.EventBurn.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.cosmos.nft.v1beta1.EventBurn.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.cosmos.nft.v1beta1.EventBurn.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.nft.v1beta1.EventBurn.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.nft.v1beta1.EventBurn}
 */
proto.cosmos.nft.v1beta1.EventBurn.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.nft.v1beta1.EventBurn.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
