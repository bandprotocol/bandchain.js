...
import * as dependency_1 from "./../../../cometbft/abci/v1/types";
...
export namespace cosmos.store.v1beta1 {
    ...
    export class BlockMetadata extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            response_commit?: dependency_1.cometbft.abci.v1.CommitResponse;
            request_finalize_block?: dependency_1.cometbft.abci.v1.FinalizeBlockRequest;
            response_finalize_block?: dependency_1.cometbft.abci.v1.FinalizeBlockResponse;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get response_commit() {
            return pb_1.Message.getWrapperField(this, dependency_1.cometbft.abci.v1.CommitResponse, 6) as dependency_1.cometbft.abci.v1.CommitResponse;
        }
        set response_commit(value: dependency_1.cometbft.abci.v1.CommitResponse) {
        ...
        get request_finalize_block() {
            return pb_1.Message.getWrapperField(this, dependency_1.cometbft.abci.v1.FinalizeBlockRequest, 7) as dependency_1.cometbft.abci.v1.FinalizeBlockRequest;
        }
        set request_finalize_block(value: dependency_1.cometbft.abci.v1.FinalizeBlockRequest) {
        ...
        get response_finalize_block() {
            return pb_1.Message.getWrapperField(this, dependency_1.cometbft.abci.v1.FinalizeBlockResponse, 8) as dependency_1.cometbft.abci.v1.FinalizeBlockResponse;
        }
        set response_finalize_block(value: dependency_1.cometbft.abci.v1.FinalizeBlockResponse) {
        ...
        static fromObject(data: {
            response_commit?: ReturnType<typeof dependency_1.cometbft.abci.v1.CommitResponse.prototype.toObject>;
            request_finalize_block?: ReturnType<typeof dependency_1.cometbft.abci.v1.FinalizeBlockRequest.prototype.toObject>;
            response_finalize_block?: ReturnType<typeof dependency_1.cometbft.abci.v1.FinalizeBlockResponse.prototype.toObject>;
        }): BlockMetadata {
            const message = new BlockMetadata({});
            if (data.response_commit != null) {
                message.response_commit = dependency_1.cometbft.abci.v1.CommitResponse.fromObject(data.response_commit);
            }
            if (data.request_finalize_block != null) {
                message.request_finalize_block = dependency_1.cometbft.abci.v1.FinalizeBlockRequest.fromObject(data.request_finalize_block);
            }
            if (data.response_finalize_block != null) {
                message.response_finalize_block = dependency_1.cometbft.abci.v1.FinalizeBlockResponse.fromObject(data.response_finalize_block);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): BlockMetadata {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 6:
                        reader.readMessage(message.response_commit, () => message.response_commit = dependency_1.cometbft.abci.v1.CommitResponse.deserialize(reader));
                        break;
                    case 7:
                        reader.readMessage(message.request_finalize_block, () => message.request_finalize_block = dependency_1.cometbft.abci.v1.FinalizeBlockRequest.deserialize(reader));
                        break;
                    case 8:
                        reader.readMessage(message.response_finalize_block, () => message.response_finalize_block = dependency_1.cometbft.abci.v1.FinalizeBlockResponse.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
