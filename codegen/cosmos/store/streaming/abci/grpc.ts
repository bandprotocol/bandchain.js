...
export namespace cosmos.store.streaming.abci {
    export class ListenFinalizeBlockRequest extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            req?: dependency_1.cometbft.abci.v1.FinalizeBlockRequest;
            res?: dependency_1.cometbft.abci.v1.FinalizeBlockResponse;
        }) {
            super();
        ...
        get req() {
            return pb_1.Message.getWrapperField(this, dependency_1.cometbft.abci.v1.FinalizeBlockRequest, 1) as dependency_1.cometbft.abci.v1.FinalizeBlockRequest;
        }
        set req(value: dependency_1.cometbft.abci.v1.FinalizeBlockRequest) {
        ...
        get res() {
            return pb_1.Message.getWrapperField(this, dependency_1.cometbft.abci.v1.FinalizeBlockResponse, 2) as dependency_1.cometbft.abci.v1.FinalizeBlockResponse;
        }
        set res(value: dependency_1.cometbft.abci.v1.FinalizeBlockResponse) {
        ...
        static fromObject(data: {
            req?: ReturnType<typeof dependency_1.cometbft.abci.v1.FinalizeBlockRequest.prototype.toObject>;
            res?: ReturnType<typeof dependency_1.cometbft.abci.v1.FinalizeBlockResponse.prototype.toObject>;
        }): ListenFinalizeBlockRequest {
            const message = new ListenFinalizeBlockRequest({});
            if (data.req != null) {
                message.req = dependency_1.cometbft.abci.v1.FinalizeBlockRequest.fromObject(data.req);
            }
            if (data.res != null) {
                message.res = dependency_1.cometbft.abci.v1.FinalizeBlockResponse.fromObject(data.res);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ListenFinalizeBlockRequest {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.req, () => message.req = dependency_1.cometbft.abci.v1.FinalizeBlockRequest.deserialize(reader));
                        break;
                    case 2:
                        reader.readMessage(message.res, () => message.res = dependency_1.cometbft.abci.v1.FinalizeBlockResponse.deserialize(reader));
                        break;
    ...
    export class ListenCommitRequest extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            block_height?: number;
            res?: dependency_1.cometbft.abci.v1.CommitResponse;
        ...
        get res() {
            return pb_1.Message.getWrapperField(this, dependency_1.cometbft.abci.v1.CommitResponse, 2) as dependency_1.cometbft.abci.v1.CommitResponse;
        }
        set res(value: dependency_1.cometbft.abci.v1.CommitResponse) {
            pb_1.Message.setWrapperField(this, 2, value);
        }
        get has_res() {
            return pb_1.Message.getField(this, 2) != null;
        ...
        static fromObject(data: {
            block_height?: number;
            res?: ReturnType<typeof dependency_1.cometbft.abci.v1.CommitResponse.prototype.toObject>;
            ...
            if (data.res != null) {
                message.res = dependency_1.cometbft.abci.v1.CommitResponse.fromObject(data.res);
            }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.res, () => message.res = dependency_1.cometbft.abci.v1.CommitResponse.deserialize(reader));
                        break;
                    case 3:
