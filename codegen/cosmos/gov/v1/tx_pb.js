...
goog.exportSymbol('proto.cosmos.gov.v1.MsgCancelProposal', null, global);
goog.exportSymbol('proto.cosmos.gov.v1.MsgCancelProposalResponse', null, global);
...
proto.cosmos.gov.v1.MsgCancelProposalResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    proposalId: jspb.Message.getFieldWithDefault(msg, 1, 0),
    canceledTime: (f = msg.getCanceledTime()) && google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f),
