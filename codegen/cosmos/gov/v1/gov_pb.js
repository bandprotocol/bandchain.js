...
proto.cosmos.gov.v1.Params.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    expeditedVotingPeriod: (f = msg.getExpeditedVotingPeriod()) && google_protobuf_duration_pb.Duration.toObject(includeInstance, f),
...
proto.cosmos.gov.v1.Params.prototype.getExpeditedMinDepositList = function() {
  return /** @type{!Array<!proto.cosmos.base.v1beta1.Coin>} */ (
    jspb.Message.getRepeatedWrapperField(this, cosmos_base_v1beta1_coin_pb.Coin, 12));
};
