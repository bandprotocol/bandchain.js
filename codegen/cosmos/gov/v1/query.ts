...
export namespace cosmos.gov.v1 {
    export class QueryConstitutionRequest extends pb_1.Message {
        #one_of_decls: number[][] = [];
        ...
        static fromObject(data: {}): QueryConstitutionRequest {
            const message = new QueryConstitutionRequest({});
            return message;
        }
        toObject() {
            const data: {} = {};
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryConstitutionRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new QueryConstitutionRequest();
        ...
        static deserializeBinary(bytes: Uint8Array): QueryConstitutionRequest {
            return QueryConstitutionRequest.deserialize(bytes);
        }
    }
    export class QueryConstitutionResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            constitution?: string;
        }) {
        ...
        set constitution(value: string) {
            pb_1.Message.setField(this, 1, value);
        }
        static fromObject(data: {
            constitution?: string;
        }): QueryConstitutionResponse {
            const message = new QueryConstitutionResponse({});
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.constitution.length)
                writer.writeString(1, this.constitution);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryConstitutionResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new QueryConstitutionResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        message.constitution = reader.readString();
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryParamsResponse extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            params?: dependency_3.cosmos.gov.v1.Params;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get params() {
            return pb_1.Message.getWrapperField(this, dependency_3.cosmos.gov.v1.Params, 4) as dependency_3.cosmos.gov.v1.Params;
        }
        set params(value: dependency_3.cosmos.gov.v1.Params) {
            pb_1.Message.setWrapperField(this, 4, value);
        }
        get has_params() {
            return pb_1.Message.getField(this, 4) != null;
        ...
        static fromObject(data: {
            ...
            params?: ReturnType<typeof dependency_3.cosmos.gov.v1.Params.prototype.toObject>;
        }): QueryParamsResponse {
            ...
            if (data.params != null) {
                message.params = dependency_3.cosmos.gov.v1.Params.fromObject(data.params);
            }
            return message;
        }
        toObject() {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        reader.readMessage(message.params, () => message.params = dependency_3.cosmos.gov.v1.Params.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export abstract class UnimplementedQueryService {
        static definition = {
            Constitution: {
                ...
                requestSerialize: (message: QueryConstitutionRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => QueryConstitutionRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: QueryConstitutionResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => QueryConstitutionResponse.deserialize(new Uint8Array(bytes))
            },
            Proposal: {
        ...
        abstract Constitution(call: grpc_1.ServerUnaryCall<QueryConstitutionRequest, QueryConstitutionResponse>, callback: grpc_1.sendUnaryData<QueryConstitutionResponse>): void;
    ...
    export class QueryClient extends grpc_1.makeGenericClientConstructor(UnimplementedQueryService.definition, "Query", {}) {
        ...
        Constitution: GrpcUnaryServiceInterface<QueryConstitutionRequest, QueryConstitutionResponse> = (message: QueryConstitutionRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<QueryConstitutionResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<QueryConstitutionResponse>, callback?: grpc_1.requestCallback<QueryConstitutionResponse>): grpc_1.ClientUnaryCall => {
            return super.Constitution(message, metadata, options, callback);
        };
