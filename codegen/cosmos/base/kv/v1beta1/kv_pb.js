...
proto.cosmos.base.kv.v1beta1.Pairs = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.cosmos.base.kv.v1beta1.Pairs.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.base.kv.v1beta1.Pairs.displayName =
    'proto.cosmos.base.kv.v1beta1.Pairs'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.base.kv.v1beta1.Pair.displayName =
    'proto.cosmos.base.kv.v1beta1.Pair'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.base.kv.v1beta1.Pairs.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.base.kv.v1beta1.Pairs.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.cosmos.base.kv.v1beta1.Pairs.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
      obj = {
        pairsList: jspb.Message.toObjectList(
          msg.getPairsList(),
          proto.cosmos.base.kv.v1beta1.Pair.toObject,
          includeInstance,
        ),
      }
...
proto.cosmos.base.kv.v1beta1.Pairs.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.base.kv.v1beta1.Pairs.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.base.kv.v1beta1.Pairs}
 */
proto.cosmos.base.kv.v1beta1.Pairs.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.cosmos.base.kv.v1beta1.Pair.deserializeBinaryFromReader,
        )
        msg.addPairs(value)
        break
      default:
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.base.kv.v1beta1.Pairs.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.cosmos.base.kv.v1beta1.Pairs.prototype.addPairs = function (
  opt_value,
  opt_index,
) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.base.kv.v1beta1.Pair.prototype.toObject = function (
    opt_includeInstance,
  ) {
...
proto.cosmos.base.kv.v1beta1.Pair.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.base.kv.v1beta1.Pair.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.base.kv.v1beta1.Pair}
 */
proto.cosmos.base.kv.v1beta1.Pair.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.base.kv.v1beta1.Pair.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
