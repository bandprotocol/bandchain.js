...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.base.node.v1beta1.ConfigRequest.displayName =
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.base.node.v1beta1.ConfigResponse.displayName =
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.base.node.v1beta1.ConfigRequest.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.base.node.v1beta1.ConfigRequest.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.cosmos.base.node.v1beta1.ConfigRequest.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
 ...
 */
proto.cosmos.base.node.v1beta1.ConfigRequest.deserializeBinary = function (
  bytes,
) {
  var reader = new jspb.BinaryReader(bytes)
  var msg = new proto.cosmos.base.node.v1beta1.ConfigRequest()
  return proto.cosmos.base.node.v1beta1.ConfigRequest.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.base.node.v1beta1.ConfigRequest}
 */
proto.cosmos.base.node.v1beta1.ConfigRequest.deserializeBinaryFromReader =
  function (msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.cosmos.base.node.v1beta1.ConfigRequest.prototype.serializeBinary =
  function () {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.base.node.v1beta1.ConfigResponse.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.base.node.v1beta1.ConfigResponse.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.cosmos.base.node.v1beta1.ConfigResponse.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
 ...
 */
proto.cosmos.base.node.v1beta1.ConfigResponse.deserializeBinary = function (
  bytes,
) {
  var reader = new jspb.BinaryReader(bytes)
  var msg = new proto.cosmos.base.node.v1beta1.ConfigResponse()
  return proto.cosmos.base.node.v1beta1.ConfigResponse.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.base.node.v1beta1.ConfigResponse}
 */
proto.cosmos.base.node.v1beta1.ConfigResponse.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break
 ...
 * @return {!Uint8Array}
 */
proto.cosmos.base.node.v1beta1.ConfigResponse.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
    proto.cosmos.base.node.v1beta1.ConfigResponse.serializeBinaryToWriter(
      this,
      writer,
    )
    return writer.getResultBuffer()
 ...
 * @return {string}
 */
proto.cosmos.base.node.v1beta1.ConfigResponse.prototype.getMinimumGasPrice =
  function () {
 ...
 */
proto.cosmos.base.node.v1beta1.ConfigResponse.prototype.setMinimumGasPrice =
  function (value) {
