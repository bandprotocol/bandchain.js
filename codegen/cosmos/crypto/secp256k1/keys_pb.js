...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.crypto.secp256k1.PubKey.displayName =
    'proto.cosmos.crypto.secp256k1.PubKey'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.crypto.secp256k1.PrivKey.displayName =
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.crypto.secp256k1.PubKey.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.crypto.secp256k1.PubKey.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.cosmos.crypto.secp256k1.PubKey.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.cosmos.crypto.secp256k1.PubKey.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.crypto.secp256k1.PubKey.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.crypto.secp256k1.PubKey}
 */
proto.cosmos.crypto.secp256k1.PubKey.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.crypto.secp256k1.PubKey.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.crypto.secp256k1.PrivKey.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.crypto.secp256k1.PrivKey.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.cosmos.crypto.secp256k1.PrivKey.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.cosmos.crypto.secp256k1.PrivKey.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.crypto.secp256k1.PrivKey.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.crypto.secp256k1.PrivKey}
 */
proto.cosmos.crypto.secp256k1.PrivKey.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.crypto.secp256k1.PrivKey.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
