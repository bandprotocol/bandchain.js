...
proto.cosmos.auth.v1beta1.GenesisState = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.cosmos.auth.v1beta1.GenesisState.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.auth.v1beta1.GenesisState.displayName =
    'proto.cosmos.auth.v1beta1.GenesisState'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.auth.v1beta1.GenesisState.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.auth.v1beta1.GenesisState.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.cosmos.auth.v1beta1.GenesisState.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.cosmos.auth.v1beta1.GenesisState.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.auth.v1beta1.GenesisState.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.auth.v1beta1.GenesisState}
 */
proto.cosmos.auth.v1beta1.GenesisState.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.auth.v1beta1.GenesisState.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 * @return {!proto.cosmos.auth.v1beta1.GenesisState} returns this
 */
proto.cosmos.auth.v1beta1.GenesisState.prototype.setAccountsList = function (
  value,
) {
 ...
 */
proto.cosmos.auth.v1beta1.GenesisState.prototype.addAccounts = function (
  opt_value,
  opt_index,
) {
 ...
 * @return {!proto.cosmos.auth.v1beta1.GenesisState} returns this
 */
proto.cosmos.auth.v1beta1.GenesisState.prototype.clearAccountsList =
  function () {
