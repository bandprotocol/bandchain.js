...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.authz.v1beta1.EventGrant.displayName =
    'proto.cosmos.authz.v1beta1.EventGrant'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.cosmos.authz.v1beta1.EventRevoke.displayName =
    'proto.cosmos.authz.v1beta1.EventRevoke'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.authz.v1beta1.EventGrant.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.authz.v1beta1.EventGrant.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.cosmos.authz.v1beta1.EventGrant.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.cosmos.authz.v1beta1.EventGrant.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.authz.v1beta1.EventGrant.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.authz.v1beta1.EventGrant}
 */
proto.cosmos.authz.v1beta1.EventGrant.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.authz.v1beta1.EventGrant.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.cosmos.authz.v1beta1.EventGrant.prototype.setMsgTypeUrl = function (
  value,
) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.cosmos.authz.v1beta1.EventRevoke.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.cosmos.authz.v1beta1.EventRevoke.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.cosmos.authz.v1beta1.EventRevoke.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.cosmos.authz.v1beta1.EventRevoke.deserializeBinary = function (bytes) {
  ...
  return proto.cosmos.authz.v1beta1.EventRevoke.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.cosmos.authz.v1beta1.EventRevoke}
 */
proto.cosmos.authz.v1beta1.EventRevoke.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cosmos.authz.v1beta1.EventRevoke.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.cosmos.authz.v1beta1.EventRevoke.prototype.setMsgTypeUrl = function (
  value,
) {
  return jspb.Message.setProto3StringField(this, 2, value)
}
