...
// file: band/feeds/v1beta1/params.proto
...
export class Params extends jspb.Message {
  ...
  getPriceQuorum(): string;
  setPriceQuorum(value: string): void;

  getMaxSignalIdsPerSigning(): number;
  setMaxSignalIdsPerSigning(value: number): void;
