...
export namespace band.tss.v1beta1 {
    ...
    export class Signing extends pb_1.Message {
        ...
        set originator(value: Uint8Array) {
            pb_1.Message.setField(this, 5, value);
        }
        get message() {
        ...
        get status() {
            return pb_1.Message.getFieldWithDefault(this, 9, SigningStatus.SIGNING_STATUS_UNSPECIFIED) as SigningStatus;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.originator.length)
                writer.writeBytes(5, this.originator);
            if (this.message.length)
                writer.writeBytes(6, this.message);
            if (this.group_pub_nonce.length)
                writer.writeBytes(7, this.group_pub_nonce);
            ...
            if (this.created_height != 0)
                writer.writeUint64(10, this.created_height);
            if (this.has_created_timestamp)
                writer.writeMessage(11, this.created_timestamp, () => this.created_timestamp.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        message.originator = reader.readBytes();
                        break;
                    case 6:
