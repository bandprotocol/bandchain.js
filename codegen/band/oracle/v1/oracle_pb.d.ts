...
export class Request extends jspb.Message {
  ...
  getTssEncoder(): EncoderMap[keyof EncoderMap];
  setTssEncoder(value: EncoderMap[keyof EncoderMap]): void;
...
export namespace Request {
  export type AsObject = {
    ...
    executeGas: number,
    tssEncoder: EncoderMap[keyof EncoderMap],
    requester: string,
...
export class OracleResultSignatureOrder extends jspb.Message {
  getRequestId(): number;
  setRequestId(value: number): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): OracleResultSignatureOrder.AsObject;
  static toObject(includeInstance: boolean, msg: OracleResultSignatureOrder): OracleResultSignatureOrder.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: OracleResultSignatureOrder, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): OracleResultSignatureOrder;
  static deserializeBinaryFromReader(message: OracleResultSignatureOrder, reader: jspb.BinaryReader): OracleResultSignatureOrder;
}

export namespace OracleResultSignatureOrder {
  export type AsObject = {
    requestId: number,
