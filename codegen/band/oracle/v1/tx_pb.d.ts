...
export class MsgRequestData extends jspb.Message {
  ...
  getTssEncoder(): band_oracle_v1_oracle_pb.EncoderMap[keyof band_oracle_v1_oracle_pb.EncoderMap];
  setTssEncoder(value: band_oracle_v1_oracle_pb.EncoderMap[keyof band_oracle_v1_oracle_pb.EncoderMap]): void;
...
export namespace MsgRequestData {
  export type AsObject = {
    ...
    executeGas: number,
    sender: string,
    tssEncoder: band_oracle_v1_oracle_pb.EncoderMap[keyof band_oracle_v1_oracle_pb.EncoderMap],
  }
}
...
export class MsgReportData extends jspb.Message {
  ...
  getRawReportsList(): Array<band_oracle_v1_oracle_pb.RawReport>;
  setRawReportsList(value: Array<band_oracle_v1_oracle_pb.RawReport>): void;
  addRawReports(value?: band_oracle_v1_oracle_pb.RawReport, index?: number): band_oracle_v1_oracle_pb.RawReport;
...
export namespace MsgReportData {
  export type AsObject = {
    requestId: number,
    rawReportsList: Array<band_oracle_v1_oracle_pb.RawReport.AsObject>,
    validator: string,
  }
}
