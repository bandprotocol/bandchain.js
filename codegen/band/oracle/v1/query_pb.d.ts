...
export class QueryDataSourceResponse extends jspb.Message {
  ...
  getDataSource(): band_oracle_v1_oracle_pb.DataSource | undefined;
  setDataSource(value?: band_oracle_v1_oracle_pb.DataSource): void;
...
export namespace QueryDataSourceResponse {
  export type AsObject = {
    dataSource?: band_oracle_v1_oracle_pb.DataSource.AsObject,
  }
}
...
export class QueryOracleScriptResponse extends jspb.Message {
  ...
  getOracleScript(): band_oracle_v1_oracle_pb.OracleScript | undefined;
  setOracleScript(value?: band_oracle_v1_oracle_pb.OracleScript): void;
...
export namespace QueryOracleScriptResponse {
  export type AsObject = {
    oracleScript?: band_oracle_v1_oracle_pb.OracleScript.AsObject,
  }
}
...
export class QueryRequestResponse extends jspb.Message {
  hasRequest(): boolean;
  clearRequest(): void;
  getRequest(): band_oracle_v1_oracle_pb.Request | undefined;
  setRequest(value?: band_oracle_v1_oracle_pb.Request): void;

  clearReportsList(): void;
  getReportsList(): Array<band_oracle_v1_oracle_pb.Report>;
  setReportsList(value: Array<band_oracle_v1_oracle_pb.Report>): void;
  addReports(value?: band_oracle_v1_oracle_pb.Report, index?: number): band_oracle_v1_oracle_pb.Report;
  ...
  hasSigning(): boolean;
  clearSigning(): void;
  getSigning(): band_oracle_v1_oracle_pb.SigningResult | undefined;
  setSigning(value?: band_oracle_v1_oracle_pb.SigningResult): void;
...
export namespace QueryRequestResponse {
  export type AsObject = {
    request?: band_oracle_v1_oracle_pb.Request.AsObject,
    reportsList: Array<band_oracle_v1_oracle_pb.Report.AsObject>,
    result?: band_oracle_v1_oracle_pb.Result.AsObject,
    signing?: band_oracle_v1_oracle_pb.SigningResult.AsObject,
  }
}
...
export class QueryValidatorResponse extends jspb.Message {
  hasStatus(): boolean;
  clearStatus(): void;
  getStatus(): band_oracle_v1_oracle_pb.ValidatorStatus | undefined;
  setStatus(value?: band_oracle_v1_oracle_pb.ValidatorStatus): void;
...
export namespace QueryValidatorResponse {
  export type AsObject = {
    status?: band_oracle_v1_oracle_pb.ValidatorStatus.AsObject,
  }
}
...
export class QueryActiveValidatorsResponse extends jspb.Message {
  ...
  getValidatorsList(): Array<band_oracle_v1_oracle_pb.ActiveValidator>;
  setValidatorsList(value: Array<band_oracle_v1_oracle_pb.ActiveValidator>): void;
  addValidators(value?: band_oracle_v1_oracle_pb.ActiveValidator, index?: number): band_oracle_v1_oracle_pb.ActiveValidator;
...
export namespace QueryActiveValidatorsResponse {
  export type AsObject = {
    validatorsList: Array<band_oracle_v1_oracle_pb.ActiveValidator.AsObject>,
  }
}
...
export class QueryRequestPriceResponse extends jspb.Message {
  ...
  getPriceResultsList(): Array<band_oracle_v1_oracle_pb.PriceResult>;
  setPriceResultsList(value: Array<band_oracle_v1_oracle_pb.PriceResult>): void;
  addPriceResults(value?: band_oracle_v1_oracle_pb.PriceResult, index?: number): band_oracle_v1_oracle_pb.PriceResult;
...
export namespace QueryRequestPriceResponse {
  export type AsObject = {
    priceResultsList: Array<band_oracle_v1_oracle_pb.PriceResult.AsObject>,
  }
}
