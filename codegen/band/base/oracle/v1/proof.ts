    ...
    export class MultiStoreProof extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("params_to_rollingseed_stores_merkle_hash" in data && data.params_to_rollingseed_stores_merkle_hash != undefined) {
                    this.params_to_rollingseed_stores_merkle_hash = data.params_to_rollingseed_stores_merkle_hash;
                }
                if ("slashing_to_tss_stores_merkle_hash" in data && data.slashing_to_tss_stores_merkle_hash != undefined) {
                    this.slashing_to_tss_stores_merkle_hash = data.slashing_to_tss_stores_merkle_hash;
                }
                if ("upgrade_store_merkle_hash" in data && data.upgrade_store_merkle_hash != undefined) {
                    this.upgrade_store_merkle_hash = data.upgrade_store_merkle_hash;
                }
        ...
        get params_to_rollingseed_stores_merkle_hash() {
            return pb_1.Message.getFieldWithDefault(this, 3, new Uint8Array(0)) as Uint8Array;
        }
        set params_to_rollingseed_stores_merkle_hash(value: Uint8Array) {
            pb_1.Message.setField(this, 3, value);
        }
        get slashing_to_tss_stores_merkle_hash() {
            return pb_1.Message.getFieldWithDefault(this, 4, new Uint8Array(0)) as Uint8Array;
        }
        set slashing_to_tss_stores_merkle_hash(value: Uint8Array) {
            pb_1.Message.setField(this, 4, value);
        }
        get upgrade_store_merkle_hash() {
            return pb_1.Message.getFieldWithDefault(this, 5, new Uint8Array(0)) as Uint8Array;
        }
        set upgrade_store_merkle_hash(value: Uint8Array) {
            pb_1.Message.setField(this, 5, value);
        }
        ...
        static fromObject(data: {
            ...
            if (data.params_to_rollingseed_stores_merkle_hash != null) {
                message.params_to_rollingseed_stores_merkle_hash = data.params_to_rollingseed_stores_merkle_hash;
            }
            if (data.slashing_to_tss_stores_merkle_hash != null) {
                message.slashing_to_tss_stores_merkle_hash = data.slashing_to_tss_stores_merkle_hash;
            }
            if (data.upgrade_store_merkle_hash != null) {
                message.upgrade_store_merkle_hash = data.upgrade_store_merkle_hash;
            }
        ...
        toObject() {
            ...
            if (this.params_to_rollingseed_stores_merkle_hash != null) {
                data.params_to_rollingseed_stores_merkle_hash = this.params_to_rollingseed_stores_merkle_hash;
            }
            if (this.slashing_to_tss_stores_merkle_hash != null) {
                data.slashing_to_tss_stores_merkle_hash = this.slashing_to_tss_stores_merkle_hash;
            }
            if (this.upgrade_store_merkle_hash != null) {
                data.upgrade_store_merkle_hash = this.upgrade_store_merkle_hash;
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.params_to_rollingseed_stores_merkle_hash.length)
                writer.writeBytes(3, this.params_to_rollingseed_stores_merkle_hash);
            if (this.slashing_to_tss_stores_merkle_hash.length)
                writer.writeBytes(4, this.slashing_to_tss_stores_merkle_hash);
            if (this.upgrade_store_merkle_hash.length)
                writer.writeBytes(5, this.upgrade_store_merkle_hash);
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        message.params_to_rollingseed_stores_merkle_hash = reader.readBytes();
                        break;
                    case 4:
                        message.slashing_to_tss_stores_merkle_hash = reader.readBytes();
                        break;
                    case 5:
                        message.upgrade_store_merkle_hash = reader.readBytes();
                        break;
                    case 6:
