...
import * as dependency_7 from "./params";
import * as dependency_8 from "./tunnel";
...
export namespace band.tunnel.v1beta1 {
    export class MsgCreateTunnel extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            signal_deviations?: dependency_8.band.tunnel.v1beta1.SignalDeviation[];
            interval?: number;
        ...
        get signal_deviations() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_8.band.tunnel.v1beta1.SignalDeviation, 1) as dependency_8.band.tunnel.v1beta1.SignalDeviation[];
        }
        set signal_deviations(value: dependency_8.band.tunnel.v1beta1.SignalDeviation[]) {
        ...
        static fromObject(data: {
            signal_deviations?: ReturnType<typeof dependency_8.band.tunnel.v1beta1.SignalDeviation.prototype.toObject>[];
            interval?: number;
            ...
            if (data.signal_deviations != null) {
                message.signal_deviations = data.signal_deviations.map(item => dependency_8.band.tunnel.v1beta1.SignalDeviation.fromObject(item));
            }
        ...
        toObject() {
            ...
            if (this.signal_deviations != null) {
                data.signal_deviations = this.signal_deviations.map((item: dependency_8.band.tunnel.v1beta1.SignalDeviation) => item.toObject());
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.signal_deviations.length)
                writer.writeRepeatedMessage(1, this.signal_deviations, (item: dependency_8.band.tunnel.v1beta1.SignalDeviation) => item.serialize(writer));
            if (this.interval != 0)
            ...
            if (this.initial_deposit.length)
                writer.writeRepeatedMessage(4, this.initial_deposit, (item: dependency_4.cosmos.base.v1beta1.Coin) => item.serialize(writer));
            if (this.creator.length)
                writer.writeString(5, this.creator);
            if (!w)
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MsgCreateTunnel {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.signal_deviations, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_8.band.tunnel.v1beta1.SignalDeviation.deserialize(reader), dependency_8.band.tunnel.v1beta1.SignalDeviation));
                        break;
                    case 2:
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        reader.readMessage(message.initial_deposit, () => pb_1.Message.addToRepeatedWrapperField(message, 4, dependency_4.cosmos.base.v1beta1.Coin.deserialize(reader), dependency_4.cosmos.base.v1beta1.Coin));
                        break;
                    case 5:
    ...
    export class MsgUpdateAndResetTunnel extends pb_1.Message {
        ...
        get signal_deviations() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_8.band.tunnel.v1beta1.SignalDeviation, 2) as dependency_8.band.tunnel.v1beta1.SignalDeviation[];
        }
        set signal_deviations(value: dependency_8.band.tunnel.v1beta1.SignalDeviation[]) {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.tunnel_id != 0)
                writer.writeUint64(1, this.tunnel_id);
            if (this.signal_deviations.length)
                writer.writeRepeatedMessage(2, this.signal_deviations, (item: dependency_8.band.tunnel.v1beta1.SignalDeviation) => item.serialize(writer));
            if (this.interval != 0)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.signal_deviations, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_8.band.tunnel.v1beta1.SignalDeviation.deserialize(reader), dependency_8.band.tunnel.v1beta1.SignalDeviation));
                        break;
                    case 3:
                        message.interval = reader.readUint64();
                        break;
    ...
    export class MsgUpdateParams extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            authority?: string;
            params?: dependency_7.band.tunnel.v1beta1.Params;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get params() {
            return pb_1.Message.getWrapperField(this, dependency_7.band.tunnel.v1beta1.Params, 2) as dependency_7.band.tunnel.v1beta1.Params;
        }
        set params(value: dependency_7.band.tunnel.v1beta1.Params) {
        ...
        static fromObject(data: {
            authority?: string;
            params?: ReturnType<typeof dependency_7.band.tunnel.v1beta1.Params.prototype.toObject>;
        }): MsgUpdateParams {
            ...
            if (data.params != null) {
                message.params = dependency_7.band.tunnel.v1beta1.Params.fromObject(data.params);
            }
            return message;
        }
        toObject() {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.params, () => message.params = dependency_7.band.tunnel.v1beta1.Params.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
