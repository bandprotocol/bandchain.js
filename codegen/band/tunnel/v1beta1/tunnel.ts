...
import * as dependency_6 from "./../../feeds/v1beta1/encoder";
...
export namespace band.tunnel.v1beta1 {
    export class Tunnel extends pb_1.Message {
        ...
        get signal_deviations() {
            return pb_1.Message.getRepeatedWrapperField(this, SignalDeviation, 5) as SignalDeviation[];
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.fee_payer.length)
                writer.writeString(4, this.fee_payer);
            if (this.signal_deviations.length)
                writer.writeRepeatedMessage(5, this.signal_deviations, (item: SignalDeviation) => item.serialize(writer));
            if (this.interval != 0)
                writer.writeUint64(6, this.interval);
            if (this.total_deposit.length)
                writer.writeRepeatedMessage(7, this.total_deposit, (item: dependency_2.cosmos.base.v1beta1.Coin) => item.serialize(writer));
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        reader.readMessage(message.signal_deviations, () => pb_1.Message.addToRepeatedWrapperField(message, 5, SignalDeviation.deserialize(reader), SignalDeviation));
                        break;
                    case 6:
                        message.interval = reader.readUint64();
                        break;
                    case 7:
                        reader.readMessage(message.total_deposit, () => pb_1.Message.addToRepeatedWrapperField(message, 7, dependency_2.cosmos.base.v1beta1.Coin.deserialize(reader), dependency_2.cosmos.base.v1beta1.Coin));
                        break;
                    case 8:
    ...
    export class LatestPrices extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            tunnel_id?: number;
            prices?: dependency_7.band.feeds.v1beta1.Price[];
        ...
        get prices() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_7.band.feeds.v1beta1.Price, 2) as dependency_7.band.feeds.v1beta1.Price[];
        }
        set prices(value: dependency_7.band.feeds.v1beta1.Price[]) {
        ...
        static fromObject(data: {
            tunnel_id?: number;
            prices?: ReturnType<typeof dependency_7.band.feeds.v1beta1.Price.prototype.toObject>[];
            last_interval?: number;
        }): LatestPrices {
            ...
            if (data.prices != null) {
                message.prices = data.prices.map(item => dependency_7.band.feeds.v1beta1.Price.fromObject(item));
            }
        ...
        toObject() {
            ...
            if (this.prices != null) {
                data.prices = this.prices.map((item: dependency_7.band.feeds.v1beta1.Price) => item.toObject());
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.prices.length)
                writer.writeRepeatedMessage(2, this.prices, (item: dependency_7.band.feeds.v1beta1.Price) => item.serialize(writer));
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.prices, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_7.band.feeds.v1beta1.Price.deserialize(reader), dependency_7.band.feeds.v1beta1.Price));
                        break;
                    case 3:
    ...
    export class Packet extends pb_1.Message {
        ...
        get prices() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_7.band.feeds.v1beta1.Price, 3) as dependency_7.band.feeds.v1beta1.Price[];
        }
        set prices(value: dependency_7.band.feeds.v1beta1.Price[]) {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.sequence != 0)
                writer.writeUint64(2, this.sequence);
            if (this.prices.length)
                writer.writeRepeatedMessage(3, this.prices, (item: dependency_7.band.feeds.v1beta1.Price) => item.serialize(writer));
            if (this.has_receipt)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        reader.readMessage(message.prices, () => pb_1.Message.addToRepeatedWrapperField(message, 3, dependency_7.band.feeds.v1beta1.Price.deserialize(reader), dependency_7.band.feeds.v1beta1.Price));
                        break;
                    case 4:
    ...
    export class TunnelSignatureOrder extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.prices.length)
                writer.writeRepeatedMessage(2, this.prices, (item: dependency_7.band.feeds.v1beta1.Price) => item.serialize(writer));
            if (this.created_at != 0)
                writer.writeInt64(3, this.created_at);
