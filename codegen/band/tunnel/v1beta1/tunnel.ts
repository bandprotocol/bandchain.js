...
export namespace band.tunnel.v1beta1 {
    ...
    export class TotalFees extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            total_packet_fee?: dependency_2.cosmos.base.v1beta1.Coin[];
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
                if ("total_packet_fee" in data && data.total_packet_fee != undefined) {
                    this.total_packet_fee = data.total_packet_fee;
                }
            }
        }
        get total_packet_fee() {
        ...
        set total_packet_fee(value: dependency_2.cosmos.base.v1beta1.Coin[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        static fromObject(data: {
            total_packet_fee?: ReturnType<typeof dependency_2.cosmos.base.v1beta1.Coin.prototype.toObject>[];
        }): TotalFees {
            const message = new TotalFees({});
            if (data.total_packet_fee != null) {
                message.total_packet_fee = data.total_packet_fee.map(item => dependency_2.cosmos.base.v1beta1.Coin.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.total_packet_fee != null) {
                data.total_packet_fee = this.total_packet_fee.map((item: dependency_2.cosmos.base.v1beta1.Coin) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.total_packet_fee.length)
                writer.writeRepeatedMessage(1, this.total_packet_fee, (item: dependency_2.cosmos.base.v1beta1.Coin) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): TotalFees {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.total_packet_fee, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_2.cosmos.base.v1beta1.Coin.deserialize(reader), dependency_2.cosmos.base.v1beta1.Coin));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class Packet extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            sequence?: number;
            prices?: dependency_6.band.feeds.v1beta1.Price[];
            packet_content?: dependency_5.google.protobuf.Any;
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("packet_content" in data && data.packet_content != undefined) {
                    this.packet_content = data.packet_content;
                }
        ...
        set packet_content(value: dependency_5.google.protobuf.Any) {
            pb_1.Message.setWrapperField(this, 4, value);
        }
        get has_packet_content() {
        ...
        static fromObject(data: {
            ...
            sequence?: number;
            prices?: ReturnType<typeof dependency_6.band.feeds.v1beta1.Price.prototype.toObject>[];
            packet_content?: ReturnType<typeof dependency_5.google.protobuf.Any.prototype.toObject>;
            ...
            if (data.packet_content != null) {
                message.packet_content = dependency_5.google.protobuf.Any.fromObject(data.packet_content);
            }
        ...
        toObject() {
            ...
            if (this.packet_content != null) {
                data.packet_content = this.packet_content.toObject();
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_packet_content)
                writer.writeMessage(4, this.packet_content, () => this.packet_content.serialize(writer));
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        reader.readMessage(message.packet_content, () => message.packet_content = dependency_5.google.protobuf.Any.deserialize(reader));
                        break;
                    case 5:
    ...
    export class TSSPacketContent extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            signing_id?: number;
            destination_chain_id?: string;
        ...
        static fromObject(data: {
            ...
            const message = new TSSPacketContent({});
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.destination_chain_id.length)
                writer.writeString(2, this.destination_chain_id);
            if (this.destination_contract_address.length)
                writer.writeString(3, this.destination_contract_address);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): TSSPacketContent {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new TSSPacketContent();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): TSSPacketContent {
            return TSSPacketContent.deserialize(bytes);
        }
    }
