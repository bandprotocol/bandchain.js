...
goog.exportSymbol('proto.band.tunnel.v1beta1.TSSPacketContent', null, global);
 ...
 * @constructor
 */
proto.band.tunnel.v1beta1.TSSPacketContent = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.band.tunnel.v1beta1.TSSPacketContent, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.band.tunnel.v1beta1.TSSPacketContent.displayName = 'proto.band.tunnel.v1beta1.TSSPacketContent';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.band.tunnel.v1beta1.TSSPacketContent.prototype.toObject = function(opt_includeInstance) {
  return proto.band.tunnel.v1beta1.TSSPacketContent.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.band.tunnel.v1beta1.TSSPacketContent} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.band.tunnel.v1beta1.TSSPacketContent.toObject = function(includeInstance, msg) {
  var f, obj = {
    signingId: jspb.Message.getFieldWithDefault(msg, 1, 0),
    destinationChainId: jspb.Message.getFieldWithDefault(msg, 2, ""),
    destinationContractAddress: jspb.Message.getFieldWithDefault(msg, 3, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.band.tunnel.v1beta1.TSSPacketContent}
 */
proto.band.tunnel.v1beta1.TSSPacketContent.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.band.tunnel.v1beta1.TSSPacketContent;
  return proto.band.tunnel.v1beta1.TSSPacketContent.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.band.tunnel.v1beta1.TSSPacketContent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.band.tunnel.v1beta1.TSSPacketContent}
 */
proto.band.tunnel.v1beta1.TSSPacketContent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.band.tunnel.v1beta1.TSSPacketContent.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.band.tunnel.v1beta1.TSSPacketContent.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.band.tunnel.v1beta1.TSSPacketContent} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.band.tunnel.v1beta1.TSSPacketContent.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.band.tunnel.v1beta1.TSSPacketContent.prototype.getSigningId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.band.tunnel.v1beta1.TSSPacketContent} returns this
 */
proto.band.tunnel.v1beta1.TSSPacketContent.prototype.setSigningId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.band.tunnel.v1beta1.TSSPacketContent.prototype.getDestinationChainId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.band.tunnel.v1beta1.TSSPacketContent} returns this
 */
proto.band.tunnel.v1beta1.TSSPacketContent.prototype.setDestinationChainId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};


/**
 * optional string destination_contract_address = 3;
 * @return {string}
 */
proto.band.tunnel.v1beta1.TSSPacketContent.prototype.getDestinationContractAddress = function() {
 ...
 * @return {!proto.band.tunnel.v1beta1.TSSPacketContent} returns this
 */
proto.band.tunnel.v1beta1.TSSPacketContent.prototype.setDestinationContractAddress = function(value) {
