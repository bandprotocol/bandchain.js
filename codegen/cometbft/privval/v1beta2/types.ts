...
export namespace cometbft.privval.v1beta2 {
    export enum Errors {
        ERRORS_UNKNOWN = 0,
    ...
    export class SignVoteRequest extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            vote?: dependency_2.cometbft.types.v1.Vote;
            chain_id?: string;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
        ...
        get vote() {
            return pb_1.Message.getWrapperField(this, dependency_2.cometbft.types.v1.Vote, 1) as dependency_2.cometbft.types.v1.Vote;
        }
        set vote(value: dependency_2.cometbft.types.v1.Vote) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_vote() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            vote?: ReturnType<typeof dependency_2.cometbft.types.v1.Vote.prototype.toObject>;
            chain_id?: string;
        }): SignVoteRequest {
            const message = new SignVoteRequest({});
            if (data.vote != null) {
                message.vote = dependency_2.cometbft.types.v1.Vote.fromObject(data.vote);
            }
            if (data.chain_id != null) {
                message.chain_id = data.chain_id;
            }
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SignVoteRequest {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.vote, () => message.vote = dependency_2.cometbft.types.v1.Vote.deserialize(reader));
                        break;
                    case 2:
                        message.chain_id = reader.readString();
                        break;
    ...
    export class SignProposalRequest extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            proposal?: dependency_2.cometbft.types.v1.Proposal;
            chain_id?: string;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
        ...
        get proposal() {
            return pb_1.Message.getWrapperField(this, dependency_2.cometbft.types.v1.Proposal, 1) as dependency_2.cometbft.types.v1.Proposal;
        }
        set proposal(value: dependency_2.cometbft.types.v1.Proposal) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_proposal() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            proposal?: ReturnType<typeof dependency_2.cometbft.types.v1.Proposal.prototype.toObject>;
            chain_id?: string;
        }): SignProposalRequest {
            const message = new SignProposalRequest({});
            if (data.proposal != null) {
                message.proposal = dependency_2.cometbft.types.v1.Proposal.fromObject(data.proposal);
            }
            if (data.chain_id != null) {
                message.chain_id = data.chain_id;
            }
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SignProposalRequest {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.proposal, () => message.proposal = dependency_2.cometbft.types.v1.Proposal.deserialize(reader));
                        break;
                    case 2:
                        message.chain_id = reader.readString();
                        break;
