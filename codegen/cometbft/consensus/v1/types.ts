...
import * as dependency_2 from "./../../libs/bits/v1/types";
import * as dependency_3 from "./../../types/v1/types";
import * as pb_1 from "google-protobuf";
export namespace cometbft.consensus.v1 {
    ...
    export class NewValidBlock extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            height?: number;
            round?: number;
            block_part_set_header?: dependency_3.cometbft.types.v1.PartSetHeader;
            block_parts?: dependency_2.cometbft.libs.bits.v1.BitArray;
            is_commit?: boolean;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
        ...
        get block_part_set_header() {
            return pb_1.Message.getWrapperField(this, dependency_3.cometbft.types.v1.PartSetHeader, 3) as dependency_3.cometbft.types.v1.PartSetHeader;
        }
        set block_part_set_header(value: dependency_3.cometbft.types.v1.PartSetHeader) {
        ...
        get block_parts() {
            return pb_1.Message.getWrapperField(this, dependency_2.cometbft.libs.bits.v1.BitArray, 4) as dependency_2.cometbft.libs.bits.v1.BitArray;
        }
        set block_parts(value: dependency_2.cometbft.libs.bits.v1.BitArray) {
        ...
        static fromObject(data: {
            height?: number;
            round?: number;
            block_part_set_header?: ReturnType<typeof dependency_3.cometbft.types.v1.PartSetHeader.prototype.toObject>;
            block_parts?: ReturnType<typeof dependency_2.cometbft.libs.bits.v1.BitArray.prototype.toObject>;
            is_commit?: boolean;
        }): NewValidBlock {
            ...
            if (data.block_part_set_header != null) {
                message.block_part_set_header = dependency_3.cometbft.types.v1.PartSetHeader.fromObject(data.block_part_set_header);
            }
            if (data.block_parts != null) {
                message.block_parts = dependency_2.cometbft.libs.bits.v1.BitArray.fromObject(data.block_parts);
            }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        reader.readMessage(message.block_part_set_header, () => message.block_part_set_header = dependency_3.cometbft.types.v1.PartSetHeader.deserialize(reader));
                        break;
                    case 4:
                        reader.readMessage(message.block_parts, () => message.block_parts = dependency_2.cometbft.libs.bits.v1.BitArray.deserialize(reader));
                        break;
                    case 5:
    ...
    export class Proposal extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            proposal?: dependency_3.cometbft.types.v1.Proposal;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get proposal() {
            return pb_1.Message.getWrapperField(this, dependency_3.cometbft.types.v1.Proposal, 1) as dependency_3.cometbft.types.v1.Proposal;
        }
        set proposal(value: dependency_3.cometbft.types.v1.Proposal) {
        ...
        static fromObject(data: {
            proposal?: ReturnType<typeof dependency_3.cometbft.types.v1.Proposal.prototype.toObject>;
        }): Proposal {
            const message = new Proposal({});
            if (data.proposal != null) {
                message.proposal = dependency_3.cometbft.types.v1.Proposal.fromObject(data.proposal);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Proposal {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.proposal, () => message.proposal = dependency_3.cometbft.types.v1.Proposal.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class ProposalPOL extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            proposal_pol?: dependency_2.cometbft.libs.bits.v1.BitArray;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get proposal_pol() {
            return pb_1.Message.getWrapperField(this, dependency_2.cometbft.libs.bits.v1.BitArray, 3) as dependency_2.cometbft.libs.bits.v1.BitArray;
        }
        set proposal_pol(value: dependency_2.cometbft.libs.bits.v1.BitArray) {
            pb_1.Message.setWrapperField(this, 3, value);
        }
        ...
        static fromObject(data: {
            height?: number;
            proposal_pol_round?: number;
            proposal_pol?: ReturnType<typeof dependency_2.cometbft.libs.bits.v1.BitArray.prototype.toObject>;
        }): ProposalPOL {
            ...
            if (data.proposal_pol != null) {
                message.proposal_pol = dependency_2.cometbft.libs.bits.v1.BitArray.fromObject(data.proposal_pol);
            }
            return message;
        }
        toObject() {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        reader.readMessage(message.proposal_pol, () => message.proposal_pol = dependency_2.cometbft.libs.bits.v1.BitArray.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class BlockPart extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            height?: number;
            round?: number;
            part?: dependency_3.cometbft.types.v1.Part;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get part() {
            return pb_1.Message.getWrapperField(this, dependency_3.cometbft.types.v1.Part, 3) as dependency_3.cometbft.types.v1.Part;
        }
        set part(value: dependency_3.cometbft.types.v1.Part) {
            pb_1.Message.setWrapperField(this, 3, value);
        }
        get has_part() {
            return pb_1.Message.getField(this, 3) != null;
        ...
        static fromObject(data: {
            height?: number;
            round?: number;
            part?: ReturnType<typeof dependency_3.cometbft.types.v1.Part.prototype.toObject>;
        }): BlockPart {
            ...
            if (data.part != null) {
                message.part = dependency_3.cometbft.types.v1.Part.fromObject(data.part);
            }
            return message;
        }
        toObject() {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        reader.readMessage(message.part, () => message.part = dependency_3.cometbft.types.v1.Part.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class Vote extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            vote?: dependency_3.cometbft.types.v1.Vote;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get vote() {
            return pb_1.Message.getWrapperField(this, dependency_3.cometbft.types.v1.Vote, 1) as dependency_3.cometbft.types.v1.Vote;
        }
        set vote(value: dependency_3.cometbft.types.v1.Vote) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_vote() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            vote?: ReturnType<typeof dependency_3.cometbft.types.v1.Vote.prototype.toObject>;
        }): Vote {
            const message = new Vote({});
            if (data.vote != null) {
                message.vote = dependency_3.cometbft.types.v1.Vote.fromObject(data.vote);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Vote {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.vote, () => message.vote = dependency_3.cometbft.types.v1.Vote.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class HasVote extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            height?: number;
            round?: number;
            type?: dependency_3.cometbft.types.v1.SignedMsgType;
            index?: number;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
        ...
        get type() {
            return pb_1.Message.getFieldWithDefault(this, 3, dependency_3.cometbft.types.v1.SignedMsgType.SIGNED_MSG_TYPE_UNKNOWN) as dependency_3.cometbft.types.v1.SignedMsgType;
        }
        set type(value: dependency_3.cometbft.types.v1.SignedMsgType) {
            pb_1.Message.setField(this, 3, value);
        }
        get index() {
            return pb_1.Message.getFieldWithDefault(this, 4, 0) as number;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.round != 0)
                writer.writeInt32(2, this.round);
            if (this.type != dependency_3.cometbft.types.v1.SignedMsgType.SIGNED_MSG_TYPE_UNKNOWN)
    ...
    export class VoteSetMaj23 extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            round?: number;
            type?: dependency_3.cometbft.types.v1.SignedMsgType;
            block_id?: dependency_3.cometbft.types.v1.BlockID;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        set block_id(value: dependency_3.cometbft.types.v1.BlockID) {
            pb_1.Message.setWrapperField(this, 4, value);
        }
        get has_block_id() {
            return pb_1.Message.getField(this, 4) != null;
        ...
        static fromObject(data: {
            ...
            round?: number;
            type?: dependency_3.cometbft.types.v1.SignedMsgType;
            block_id?: ReturnType<typeof dependency_3.cometbft.types.v1.BlockID.prototype.toObject>;
        }): VoteSetMaj23 {
            ...
            if (data.block_id != null) {
                message.block_id = dependency_3.cometbft.types.v1.BlockID.fromObject(data.block_id);
            }
            return message;
        }
        toObject() {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        reader.readMessage(message.block_id, () => message.block_id = dependency_3.cometbft.types.v1.BlockID.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class VoteSetBits extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            type?: dependency_3.cometbft.types.v1.SignedMsgType;
            block_id?: dependency_3.cometbft.types.v1.BlockID;
            votes?: dependency_2.cometbft.libs.bits.v1.BitArray;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get votes() {
            return pb_1.Message.getWrapperField(this, dependency_2.cometbft.libs.bits.v1.BitArray, 5) as dependency_2.cometbft.libs.bits.v1.BitArray;
        }
        set votes(value: dependency_2.cometbft.libs.bits.v1.BitArray) {
        ...
        static fromObject(data: {
            ...
            type?: dependency_3.cometbft.types.v1.SignedMsgType;
            block_id?: ReturnType<typeof dependency_3.cometbft.types.v1.BlockID.prototype.toObject>;
            votes?: ReturnType<typeof dependency_2.cometbft.libs.bits.v1.BitArray.prototype.toObject>;
        }): VoteSetBits {
            ...
            if (data.votes != null) {
                message.votes = dependency_2.cometbft.libs.bits.v1.BitArray.fromObject(data.votes);
            }
            return message;
        }
        toObject() {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        reader.readMessage(message.votes, () => message.votes = dependency_2.cometbft.libs.bits.v1.BitArray.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
