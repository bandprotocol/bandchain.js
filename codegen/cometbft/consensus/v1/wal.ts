...
import * as dependency_2 from "./../../types/v1/events";
...
export namespace cometbft.consensus.v1 {
    export class MsgInfo extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            msg?: dependency_1.cometbft.consensus.v1.Message;
            peer_id?: string;
            receive_time?: dependency_5.google.protobuf.Timestamp;
        }) {
            super();
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("receive_time" in data && data.receive_time != undefined) {
                    this.receive_time = data.receive_time;
                }
            }
        }
        get msg() {
            return pb_1.Message.getWrapperField(this, dependency_1.cometbft.consensus.v1.Message, 1) as dependency_1.cometbft.consensus.v1.Message;
        }
        set msg(value: dependency_1.cometbft.consensus.v1.Message) {
        ...
        set receive_time(value: dependency_5.google.protobuf.Timestamp) {
            pb_1.Message.setWrapperField(this, 3, value);
        }
        get has_receive_time() {
            return pb_1.Message.getField(this, 3) != null;
        }
        static fromObject(data: {
            msg?: ReturnType<typeof dependency_1.cometbft.consensus.v1.Message.prototype.toObject>;
            peer_id?: string;
            receive_time?: ReturnType<typeof dependency_5.google.protobuf.Timestamp.prototype.toObject>;
        }): MsgInfo {
            const message = new MsgInfo({});
            if (data.msg != null) {
                message.msg = dependency_1.cometbft.consensus.v1.Message.fromObject(data.msg);
            }
            if (data.peer_id != null) {
                message.peer_id = data.peer_id;
            }
            if (data.receive_time != null) {
                message.receive_time = dependency_5.google.protobuf.Timestamp.fromObject(data.receive_time);
            }
            return message;
        }
        toObject() {
            ...
            if (this.receive_time != null) {
                data.receive_time = this.receive_time.toObject();
            }
            return data;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_receive_time)
                writer.writeMessage(3, this.receive_time, () => this.receive_time.serialize(writer));
            if (!w)
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MsgInfo {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.msg, () => message.msg = dependency_1.cometbft.consensus.v1.Message.deserialize(reader));
                        break;
                    case 2:
                        message.peer_id = reader.readString();
                        break;
                    case 3:
                        reader.readMessage(message.receive_time, () => message.receive_time = dependency_5.google.protobuf.Timestamp.deserialize(reader));
                        break;
    ...
    export class WALMessage extends pb_1.Message {
        ...
        constructor(data?: any[] | ({} & (({
            event_data_round_state?: dependency_2.cometbft.types.v1.EventDataRoundState;
            msg_info?: never;
            timeout_info?: never;
            end_height?: never;
        } | {
        ...
        get event_data_round_state() {
            return pb_1.Message.getWrapperField(this, dependency_2.cometbft.types.v1.EventDataRoundState, 1) as dependency_2.cometbft.types.v1.EventDataRoundState;
        }
        set event_data_round_state(value: dependency_2.cometbft.types.v1.EventDataRoundState) {
        ...
        static fromObject(data: {
            event_data_round_state?: ReturnType<typeof dependency_2.cometbft.types.v1.EventDataRoundState.prototype.toObject>;
            ...
            if (data.event_data_round_state != null) {
                message.event_data_round_state = dependency_2.cometbft.types.v1.EventDataRoundState.fromObject(data.event_data_round_state);
            }
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): WALMessage {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.event_data_round_state, () => message.event_data_round_state = dependency_2.cometbft.types.v1.EventDataRoundState.deserialize(reader));
                        break;
                    case 2:
