...
import * as dependency_3 from "./../../types/v1beta1/events";
...
export namespace cometbft.consensus.v1beta1 {
    export class MsgInfo extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            msg?: dependency_2.cometbft.consensus.v1beta1.Message;
            peer_id?: string;
        }) {
            super();
        ...
        get msg() {
            return pb_1.Message.getWrapperField(this, dependency_2.cometbft.consensus.v1beta1.Message, 1) as dependency_2.cometbft.consensus.v1beta1.Message;
        }
        set msg(value: dependency_2.cometbft.consensus.v1beta1.Message) {
        ...
        static fromObject(data: {
            msg?: ReturnType<typeof dependency_2.cometbft.consensus.v1beta1.Message.prototype.toObject>;
            peer_id?: string;
        }): MsgInfo {
            const message = new MsgInfo({});
            if (data.msg != null) {
                message.msg = dependency_2.cometbft.consensus.v1beta1.Message.fromObject(data.msg);
            }
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MsgInfo {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.msg, () => message.msg = dependency_2.cometbft.consensus.v1beta1.Message.deserialize(reader));
                        break;
                    case 2:
    ...
    export class WALMessage extends pb_1.Message {
        ...
        constructor(data?: any[] | ({} & (({
            event_data_round_state?: dependency_3.cometbft.types.v1beta1.EventDataRoundState;
            msg_info?: never;
            timeout_info?: never;
            end_height?: never;
        } | {
        ...
        get event_data_round_state() {
            return pb_1.Message.getWrapperField(this, dependency_3.cometbft.types.v1beta1.EventDataRoundState, 1) as dependency_3.cometbft.types.v1beta1.EventDataRoundState;
        }
        set event_data_round_state(value: dependency_3.cometbft.types.v1beta1.EventDataRoundState) {
        ...
        static fromObject(data: {
            event_data_round_state?: ReturnType<typeof dependency_3.cometbft.types.v1beta1.EventDataRoundState.prototype.toObject>;
            ...
            if (data.event_data_round_state != null) {
                message.event_data_round_state = dependency_3.cometbft.types.v1beta1.EventDataRoundState.fromObject(data.event_data_round_state);
            }
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): WALMessage {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.event_data_round_state, () => message.event_data_round_state = dependency_3.cometbft.types.v1beta1.EventDataRoundState.deserialize(reader));
                        break;
                    case 2:
