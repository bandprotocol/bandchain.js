...
import * as dependency_2 from "./../../../abci/v1beta3/types";
import * as pb_1 from "google-protobuf";
import * as grpc_1 from "@grpc/grpc-js";
export namespace cometbft.rpc.grpc.v1beta3 {
    export class ResponseBroadcastTx extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            check_tx?: dependency_2.cometbft.abci.v1beta3.ResponseCheckTx;
            tx_result?: dependency_2.cometbft.abci.v1beta3.ExecTxResult;
        }) {
            super();
        ...
        get check_tx() {
            return pb_1.Message.getWrapperField(this, dependency_2.cometbft.abci.v1beta3.ResponseCheckTx, 1) as dependency_2.cometbft.abci.v1beta3.ResponseCheckTx;
        }
        set check_tx(value: dependency_2.cometbft.abci.v1beta3.ResponseCheckTx) {
        ...
        get tx_result() {
            return pb_1.Message.getWrapperField(this, dependency_2.cometbft.abci.v1beta3.ExecTxResult, 2) as dependency_2.cometbft.abci.v1beta3.ExecTxResult;
        }
        set tx_result(value: dependency_2.cometbft.abci.v1beta3.ExecTxResult) {
        ...
        static fromObject(data: {
            check_tx?: ReturnType<typeof dependency_2.cometbft.abci.v1beta3.ResponseCheckTx.prototype.toObject>;
            tx_result?: ReturnType<typeof dependency_2.cometbft.abci.v1beta3.ExecTxResult.prototype.toObject>;
        }): ResponseBroadcastTx {
            const message = new ResponseBroadcastTx({});
            if (data.check_tx != null) {
                message.check_tx = dependency_2.cometbft.abci.v1beta3.ResponseCheckTx.fromObject(data.check_tx);
            }
            if (data.tx_result != null) {
                message.tx_result = dependency_2.cometbft.abci.v1beta3.ExecTxResult.fromObject(data.tx_result);
            }
            return message;
        }
        toObject() {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_tx_result)
                writer.writeMessage(2, this.tx_result, () => this.tx_result.serialize(writer));
            if (!w)
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ResponseBroadcastTx {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.check_tx, () => message.check_tx = dependency_2.cometbft.abci.v1beta3.ResponseCheckTx.deserialize(reader));
                        break;
                    case 2:
                        reader.readMessage(message.tx_result, () => message.tx_result = dependency_2.cometbft.abci.v1beta3.ExecTxResult.deserialize(reader));
                        break;
    ...
    export abstract class UnimplementedBroadcastAPIService {
        static definition = {
            Ping: {
                path: "/cometbft.rpc.grpc.v1beta3.BroadcastAPI/Ping",
                requestStream: false,
            ...
            BroadcastTx: {
                path: "/cometbft.rpc.grpc.v1beta3.BroadcastAPI/BroadcastTx",
                requestStream: false,
                responseStream: false,
