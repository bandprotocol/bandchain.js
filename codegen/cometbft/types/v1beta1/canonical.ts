...
export namespace cometbft.types.v1beta1 {
    ...
    export class CanonicalProposal extends pb_1.Message {
        ...
        get type() {
            return pb_1.Message.getFieldWithDefault(this, 1, dependency_2.cometbft.types.v1beta1.SignedMsgType.SIGNED_MSG_TYPE_UNKNOWN) as dependency_2.cometbft.types.v1beta1.SignedMsgType;
        }
