...
export namespace cometbft.types.v1beta1 {
    ...
    export class DuplicateVoteEvidence extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            vote_a?: dependency_3.cometbft.types.v1beta1.Vote;
            vote_b?: dependency_3.cometbft.types.v1beta1.Vote;
        ...
        get vote_a() {
            return pb_1.Message.getWrapperField(this, dependency_3.cometbft.types.v1beta1.Vote, 1) as dependency_3.cometbft.types.v1beta1.Vote;
        }
        set vote_a(value: dependency_3.cometbft.types.v1beta1.Vote) {
        ...
        get vote_b() {
            return pb_1.Message.getWrapperField(this, dependency_3.cometbft.types.v1beta1.Vote, 2) as dependency_3.cometbft.types.v1beta1.Vote;
        }
        set vote_b(value: dependency_3.cometbft.types.v1beta1.Vote) {
        ...
        static fromObject(data: {
            vote_a?: ReturnType<typeof dependency_3.cometbft.types.v1beta1.Vote.prototype.toObject>;
            vote_b?: ReturnType<typeof dependency_3.cometbft.types.v1beta1.Vote.prototype.toObject>;
            total_voting_power?: number;
            validator_power?: number;
            ...
            if (data.vote_a != null) {
                message.vote_a = dependency_3.cometbft.types.v1beta1.Vote.fromObject(data.vote_a);
            }
            if (data.vote_b != null) {
                message.vote_b = dependency_3.cometbft.types.v1beta1.Vote.fromObject(data.vote_b);
            }
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): DuplicateVoteEvidence {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.vote_a, () => message.vote_a = dependency_3.cometbft.types.v1beta1.Vote.deserialize(reader));
                        break;
                    case 2:
                        reader.readMessage(message.vote_b, () => message.vote_b = dependency_3.cometbft.types.v1beta1.Vote.deserialize(reader));
                        break;
                    case 3:
    ...
    export class LightClientAttackEvidence extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            conflicting_block?: dependency_3.cometbft.types.v1beta1.LightBlock;
            common_height?: number;
            byzantine_validators?: dependency_4.cometbft.types.v1beta1.Validator[];
            total_voting_power?: number;
            timestamp?: dependency_2.google.protobuf.Timestamp;
        }) {
            super();
        ...
        get conflicting_block() {
            return pb_1.Message.getWrapperField(this, dependency_3.cometbft.types.v1beta1.LightBlock, 1) as dependency_3.cometbft.types.v1beta1.LightBlock;
        }
        set conflicting_block(value: dependency_3.cometbft.types.v1beta1.LightBlock) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        ...
        get byzantine_validators() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_4.cometbft.types.v1beta1.Validator, 3) as dependency_4.cometbft.types.v1beta1.Validator[];
        }
        set byzantine_validators(value: dependency_4.cometbft.types.v1beta1.Validator[]) {
        ...
        static fromObject(data: {
            conflicting_block?: ReturnType<typeof dependency_3.cometbft.types.v1beta1.LightBlock.prototype.toObject>;
            common_height?: number;
            byzantine_validators?: ReturnType<typeof dependency_4.cometbft.types.v1beta1.Validator.prototype.toObject>[];
            total_voting_power?: number;
            timestamp?: ReturnType<typeof dependency_2.google.protobuf.Timestamp.prototype.toObject>;
        }): LightClientAttackEvidence {
            const message = new LightClientAttackEvidence({});
            if (data.conflicting_block != null) {
                message.conflicting_block = dependency_3.cometbft.types.v1beta1.LightBlock.fromObject(data.conflicting_block);
            }
            if (data.common_height != null) {
                message.common_height = data.common_height;
            }
            if (data.byzantine_validators != null) {
                message.byzantine_validators = data.byzantine_validators.map(item => dependency_4.cometbft.types.v1beta1.Validator.fromObject(item));
            }
            if (data.total_voting_power != null) {
                message.total_voting_power = data.total_voting_power;
            }
        ...
        toObject() {
            ...
            if (this.byzantine_validators != null) {
                data.byzantine_validators = this.byzantine_validators.map((item: dependency_4.cometbft.types.v1beta1.Validator) => item.toObject());
            }
            if (this.total_voting_power != null) {
                data.total_voting_power = this.total_voting_power;
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.byzantine_validators.length)
                writer.writeRepeatedMessage(3, this.byzantine_validators, (item: dependency_4.cometbft.types.v1beta1.Validator) => item.serialize(writer));
            if (this.total_voting_power != 0)
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): LightClientAttackEvidence {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.conflicting_block, () => message.conflicting_block = dependency_3.cometbft.types.v1beta1.LightBlock.deserialize(reader));
                        break;
                    case 2:
                        message.common_height = reader.readInt64();
                        break;
                    case 3:
                        reader.readMessage(message.byzantine_validators, () => pb_1.Message.addToRepeatedWrapperField(message, 3, dependency_4.cometbft.types.v1beta1.Validator.deserialize(reader), dependency_4.cometbft.types.v1beta1.Validator));
                        break;
                    case 4:
                        message.total_voting_power = reader.readInt64();
                        break;
