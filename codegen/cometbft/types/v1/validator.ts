...
export namespace cometbft.types.v1 {
    ...
    export class Validator extends pb_1.Message {
        ...
        /** @deprecated*/
        get pub_key() {
            return pb_1.Message.getWrapperField(this, dependency_1.cometbft.crypto.v1.PublicKey, 2) as dependency_1.cometbft.crypto.v1.PublicKey;
        }
        /** @deprecated*/
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.pub_key_bytes.length)
                writer.writeBytes(5, this.pub_key_bytes);
            if (this.pub_key_type.length)
                writer.writeString(6, this.pub_key_type);
            if (!w)
                return writer.getResultBuffer();
        }
