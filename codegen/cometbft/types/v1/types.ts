...
import * as dependency_3 from "./../../version/v1/types";
...
export namespace cometbft.types.v1 {
    ...
    export class Part extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            index?: number;
            bytes?: Uint8Array;
            proof?: dependency_1.cometbft.crypto.v1.Proof;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get proof() {
            return pb_1.Message.getWrapperField(this, dependency_1.cometbft.crypto.v1.Proof, 3) as dependency_1.cometbft.crypto.v1.Proof;
        }
        set proof(value: dependency_1.cometbft.crypto.v1.Proof) {
        ...
        static fromObject(data: {
            index?: number;
            bytes?: Uint8Array;
            proof?: ReturnType<typeof dependency_1.cometbft.crypto.v1.Proof.prototype.toObject>;
        }): Part {
            ...
            if (data.proof != null) {
                message.proof = dependency_1.cometbft.crypto.v1.Proof.fromObject(data.proof);
            }
            return message;
        }
        toObject() {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        reader.readMessage(message.proof, () => message.proof = dependency_1.cometbft.crypto.v1.Proof.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class Header extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            version?: dependency_3.cometbft.version.v1.Consensus;
            chain_id?: string;
            height?: number;
        ...
        get version() {
            return pb_1.Message.getWrapperField(this, dependency_3.cometbft.version.v1.Consensus, 1) as dependency_3.cometbft.version.v1.Consensus;
        }
        set version(value: dependency_3.cometbft.version.v1.Consensus) {
        ...
        static fromObject(data: {
            version?: ReturnType<typeof dependency_3.cometbft.version.v1.Consensus.prototype.toObject>;
            chain_id?: string;
            height?: number;
            ...
            if (data.version != null) {
                message.version = dependency_3.cometbft.version.v1.Consensus.fromObject(data.version);
            }
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Header {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.version, () => message.version = dependency_3.cometbft.version.v1.Consensus.deserialize(reader));
                        break;
                    case 2:
    ...
    export class CommitSig extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            block_id_flag?: dependency_2.cometbft.types.v1.BlockIDFlag;
            validator_address?: Uint8Array;
            timestamp?: dependency_5.google.protobuf.Timestamp;
            signature?: Uint8Array;
        }) {
        ...
        get block_id_flag() {
            return pb_1.Message.getFieldWithDefault(this, 1, dependency_2.cometbft.types.v1.BlockIDFlag.BLOCK_ID_FLAG_UNKNOWN) as dependency_2.cometbft.types.v1.BlockIDFlag;
        }
        set block_id_flag(value: dependency_2.cometbft.types.v1.BlockIDFlag) {
            pb_1.Message.setField(this, 1, value);
        }
        get validator_address() {
            return pb_1.Message.getFieldWithDefault(this, 2, new Uint8Array(0)) as Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.block_id_flag != dependency_2.cometbft.types.v1.BlockIDFlag.BLOCK_ID_FLAG_UNKNOWN)
    ...
    export class LightBlock extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            validator_set?: dependency_2.cometbft.types.v1.ValidatorSet;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get validator_set() {
            return pb_1.Message.getWrapperField(this, dependency_2.cometbft.types.v1.ValidatorSet, 2) as dependency_2.cometbft.types.v1.ValidatorSet;
        }
        set validator_set(value: dependency_2.cometbft.types.v1.ValidatorSet) {
            pb_1.Message.setWrapperField(this, 2, value);
        }
        ...
        static fromObject(data: {
            ...
            validator_set?: ReturnType<typeof dependency_2.cometbft.types.v1.ValidatorSet.prototype.toObject>;
        }): LightBlock {
            ...
            if (data.validator_set != null) {
                message.validator_set = dependency_2.cometbft.types.v1.ValidatorSet.fromObject(data.validator_set);
            }
            return message;
        }
        toObject() {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.validator_set, () => message.validator_set = dependency_2.cometbft.types.v1.ValidatorSet.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
