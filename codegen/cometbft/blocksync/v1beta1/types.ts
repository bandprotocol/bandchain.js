...
import * as dependency_1 from "./../../types/v1beta1/block";
import * as pb_1 from "google-protobuf";
export namespace cometbft.blocksync.v1beta1 {
    ...
    export class BlockResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            block?: dependency_1.cometbft.types.v1beta1.Block;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get block() {
            return pb_1.Message.getWrapperField(this, dependency_1.cometbft.types.v1beta1.Block, 1) as dependency_1.cometbft.types.v1beta1.Block;
        }
        set block(value: dependency_1.cometbft.types.v1beta1.Block) {
        ...
        static fromObject(data: {
            block?: ReturnType<typeof dependency_1.cometbft.types.v1beta1.Block.prototype.toObject>;
        }): BlockResponse {
            const message = new BlockResponse({});
            if (data.block != null) {
                message.block = dependency_1.cometbft.types.v1beta1.Block.fromObject(data.block);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): BlockResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.block, () => message.block = dependency_1.cometbft.types.v1beta1.Block.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
