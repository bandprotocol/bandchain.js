...
goog.exportSymbol(
  'proto.tendermint.types.LightClientAttackEvidence',
  null,
  global,
)
/**
...
proto.tendermint.types.Evidence = function (opt_data) {
  jspb.Message.initialize(
    ...
    -1,
    null,
    proto.tendermint.types.Evidence.oneofGroups_,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.tendermint.types.Evidence.displayName =
    'proto.tendermint.types.Evidence'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.tendermint.types.DuplicateVoteEvidence.displayName =
    'proto.tendermint.types.DuplicateVoteEvidence'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.tendermint.types.LightClientAttackEvidence = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.tendermint.types.LightClientAttackEvidence.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.tendermint.types.LightClientAttackEvidence.displayName =
    'proto.tendermint.types.LightClientAttackEvidence'
}
/**
 * Generated by JsPbCodeGenerator.
...
proto.tendermint.types.EvidenceList = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.tendermint.types.EvidenceList.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.tendermint.types.EvidenceList.displayName =
    'proto.tendermint.types.EvidenceList'
}
...
proto.tendermint.types.Evidence.prototype.getSumCase = function () {
  return /** @type {proto.tendermint.types.Evidence.SumCase} */ (
    jspb.Message.computeOneofCase(
      this,
      proto.tendermint.types.Evidence.oneofGroups_[0],
    )
  )
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.tendermint.types.Evidence.prototype.toObject = function (
    opt_includeInstance,
  ) {
    ...
    var f,
      obj = {
        duplicateVoteEvidence:
          (f = msg.getDuplicateVoteEvidence()) &&
          proto.tendermint.types.DuplicateVoteEvidence.toObject(
            includeInstance,
            f,
          ),
        lightClientAttackEvidence:
          (f = msg.getLightClientAttackEvidence()) &&
          proto.tendermint.types.LightClientAttackEvidence.toObject(
            includeInstance,
            f,
          ),
      }
...
proto.tendermint.types.Evidence.deserializeBinary = function (bytes) {
  ...
  return proto.tendermint.types.Evidence.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.tendermint.types.Evidence}
 */
proto.tendermint.types.Evidence.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tendermint.types.Evidence.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.tendermint.types.Evidence.prototype.getDuplicateVoteEvidence =
  function () {
 ...
 */
proto.tendermint.types.Evidence.prototype.setDuplicateVoteEvidence = function (
  value,
) {
 ...
 * @return {!proto.tendermint.types.Evidence} returns this
 */
proto.tendermint.types.Evidence.prototype.clearDuplicateVoteEvidence =
  function () {
 ...
 * @return {boolean}
 */
proto.tendermint.types.Evidence.prototype.hasDuplicateVoteEvidence =
  function () {
 ...
 */
proto.tendermint.types.Evidence.prototype.getLightClientAttackEvidence =
  function () {
 ...
 * @return {!proto.tendermint.types.Evidence} returns this
 */
proto.tendermint.types.Evidence.prototype.setLightClientAttackEvidence =
  function (value) {
    return jspb.Message.setOneofWrapperField(
      this,
      2,
 ...
 * @return {!proto.tendermint.types.Evidence} returns this
 */
proto.tendermint.types.Evidence.prototype.clearLightClientAttackEvidence =
  function () {
 ...
 * @return {boolean}
 */
proto.tendermint.types.Evidence.prototype.hasLightClientAttackEvidence =
  function () {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.tendermint.types.DuplicateVoteEvidence.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.tendermint.types.DuplicateVoteEvidence.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.tendermint.types.DuplicateVoteEvidence.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
      obj = {
        voteA:
          (f = msg.getVoteA()) &&
          tendermint_types_types_pb.Vote.toObject(includeInstance, f),
        voteB:
          (f = msg.getVoteB()) &&
          tendermint_types_types_pb.Vote.toObject(includeInstance, f),
 ...
 * @return {!proto.tendermint.types.DuplicateVoteEvidence}
 */
proto.tendermint.types.DuplicateVoteEvidence.deserializeBinary = function (
  bytes,
) {
  var reader = new jspb.BinaryReader(bytes)
  var msg = new proto.tendermint.types.DuplicateVoteEvidence()
  return proto.tendermint.types.DuplicateVoteEvidence.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.tendermint.types.DuplicateVoteEvidence}
 */
proto.tendermint.types.DuplicateVoteEvidence.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break
      ...
      switch (field) {
        case 1:
          ...
          reader.readMessage(
            value,
            tendermint_types_types_pb.Vote.deserializeBinaryFromReader,
          )
          msg.setVoteA(value)
          break
        case 2:
 ...
 * @return {!Uint8Array}
 */
proto.tendermint.types.DuplicateVoteEvidence.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
    proto.tendermint.types.DuplicateVoteEvidence.serializeBinaryToWriter(
      this,
 ...
 */
proto.tendermint.types.DuplicateVoteEvidence.prototype.setVoteA = function (
  value,
) {
 ...
 * @return {!proto.tendermint.types.DuplicateVoteEvidence} returns this
 */
proto.tendermint.types.DuplicateVoteEvidence.prototype.clearVoteA =
  function () {
 ...
 * @return {!proto.tendermint.types.DuplicateVoteEvidence} returns this
 */
proto.tendermint.types.DuplicateVoteEvidence.prototype.setVoteB = function (
  value,
) {
 ...
 * @return {!proto.tendermint.types.DuplicateVoteEvidence} returns this
 */
proto.tendermint.types.DuplicateVoteEvidence.prototype.clearVoteB =
  function () {
 ...
 * @return {number}
 */
proto.tendermint.types.DuplicateVoteEvidence.prototype.getTotalVotingPower =
  function () {
 ...
 * @return {!proto.tendermint.types.DuplicateVoteEvidence} returns this
 */
proto.tendermint.types.DuplicateVoteEvidence.prototype.setTotalVotingPower =
  function (value) {
 ...
 * @return {number}
 */
proto.tendermint.types.DuplicateVoteEvidence.prototype.getValidatorPower =
  function () {
 ...
 * @return {!proto.tendermint.types.DuplicateVoteEvidence} returns this
 */
proto.tendermint.types.DuplicateVoteEvidence.prototype.setValidatorPower =
  function (value) {
 ...
 */
proto.tendermint.types.DuplicateVoteEvidence.prototype.getTimestamp =
  function () {
 ...
 * @return {!proto.tendermint.types.DuplicateVoteEvidence} returns this
 */
proto.tendermint.types.DuplicateVoteEvidence.prototype.setTimestamp = function (
  value,
) {
 ...
 * @return {!proto.tendermint.types.DuplicateVoteEvidence} returns this
 */
proto.tendermint.types.DuplicateVoteEvidence.prototype.clearTimestamp =
  function () {
 ...
 * @return {boolean}
 */
proto.tendermint.types.DuplicateVoteEvidence.prototype.hasTimestamp =
  function () {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.tendermint.types.LightClientAttackEvidence.prototype.toObject =
    function (opt_includeInstance) {
      return proto.tendermint.types.LightClientAttackEvidence.toObject(
        opt_includeInstance,
        this,
      )
    }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.tendermint.types.LightClientAttackEvidence.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
      obj = {
        conflictingBlock:
          ...
          tendermint_types_types_pb.LightBlock.toObject(includeInstance, f),
        ...
        byzantineValidatorsList: jspb.Message.toObjectList(
          ...
          tendermint_types_validator_pb.Validator.toObject,
          includeInstance,
        ),
 ...
 * @return {!proto.tendermint.types.LightClientAttackEvidence}
 */
proto.tendermint.types.LightClientAttackEvidence.deserializeBinary = function (
  bytes,
) {
  var reader = new jspb.BinaryReader(bytes)
  var msg = new proto.tendermint.types.LightClientAttackEvidence()
  return proto.tendermint.types.LightClientAttackEvidence.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.tendermint.types.LightClientAttackEvidence}
 */
proto.tendermint.types.LightClientAttackEvidence.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break
      ...
      switch (field) {
        case 1:
          ...
          reader.readMessage(
            value,
            tendermint_types_types_pb.LightBlock.deserializeBinaryFromReader,
          )
        ...
        case 3:
          ...
          reader.readMessage(
            value,
            tendermint_types_validator_pb.Validator.deserializeBinaryFromReader,
          )
 ...
 * @return {!Uint8Array}
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter()
    proto.tendermint.types.LightClientAttackEvidence.serializeBinaryToWriter(
      this,
 ...
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.getConflictingBlock =
  function () {
    return /** @type{?proto.tendermint.types.LightBlock} */ (
      jspb.Message.getWrapperField(
        this,
        tendermint_types_types_pb.LightBlock,
        1,
      )
    )
  }
 ...
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.setConflictingBlock =
  function (value) {
    return jspb.Message.setWrapperField(this, 1, value)
  }
 ...
 * @return {!proto.tendermint.types.LightClientAttackEvidence} returns this
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.clearConflictingBlock =
  function () {
 ...
 * @return {boolean}
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.hasConflictingBlock =
  function () {
    return jspb.Message.getField(this, 1) != null
  }
 ...
 * @return {number}
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.getCommonHeight =
  function () {
 ...
 * @return {!proto.tendermint.types.LightClientAttackEvidence} returns this
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.setCommonHeight =
  function (value) {
 ...
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.getByzantineValidatorsList =
  function () {
 ...
 * @return {!proto.tendermint.types.LightClientAttackEvidence} returns this
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.setByzantineValidatorsList =
  function (value) {
 ...
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.addByzantineValidators =
  function (opt_value, opt_index) {
    return jspb.Message.addToRepeatedWrapperField(
      this,
      3,
      opt_value,
      proto.tendermint.types.Validator,
      opt_index,
    )
  }
 ...
 * @return {!proto.tendermint.types.LightClientAttackEvidence} returns this
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.clearByzantineValidatorsList =
  function () {
 ...
 * @return {number}
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.getTotalVotingPower =
  function () {
    return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0))
  }
 ...
 * @return {!proto.tendermint.types.LightClientAttackEvidence} returns this
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.setTotalVotingPower =
  function (value) {
    return jspb.Message.setProto3IntField(this, 4, value)
  }
 ...
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.getTimestamp =
  function () {
    return /** @type{?proto.google.protobuf.Timestamp} */ (
      jspb.Message.getWrapperField(
        this,
 ...
 * @return {!proto.tendermint.types.LightClientAttackEvidence} returns this
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.setTimestamp =
  function (value) {
    return jspb.Message.setWrapperField(this, 5, value)
  }
 ...
 * @return {!proto.tendermint.types.LightClientAttackEvidence} returns this
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.clearTimestamp =
  function () {
    return this.setTimestamp(undefined)
  }
 ...
 * @return {boolean}
 */
proto.tendermint.types.LightClientAttackEvidence.prototype.hasTimestamp =
  function () {
    return jspb.Message.getField(this, 5) != null
  }
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.tendermint.types.EvidenceList.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.tendermint.types.EvidenceList.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.tendermint.types.EvidenceList.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
      obj = {
        evidenceList: jspb.Message.toObjectList(
          msg.getEvidenceList(),
          proto.tendermint.types.Evidence.toObject,
          includeInstance,
        ),
      }
...
proto.tendermint.types.EvidenceList.deserializeBinary = function (bytes) {
  ...
  return proto.tendermint.types.EvidenceList.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.tendermint.types.EvidenceList}
 */
proto.tendermint.types.EvidenceList.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.tendermint.types.Evidence.deserializeBinaryFromReader,
        )
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tendermint.types.EvidenceList.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.tendermint.types.EvidenceList.prototype.setEvidenceList = function (
  value,
) {
 ...
 * @return {!proto.tendermint.types.Evidence}
 */
proto.tendermint.types.EvidenceList.prototype.addEvidence = function (
  opt_value,
  opt_index,
) {
  return jspb.Message.addToRepeatedWrapperField(
