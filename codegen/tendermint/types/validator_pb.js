...
proto.tendermint.types.ValidatorSet = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.tendermint.types.ValidatorSet.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.tendermint.types.ValidatorSet.displayName =
    'proto.tendermint.types.ValidatorSet'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.tendermint.types.Validator.displayName =
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.tendermint.types.SimpleValidator.displayName =
    'proto.tendermint.types.SimpleValidator'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.tendermint.types.ValidatorSet.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.tendermint.types.ValidatorSet.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.tendermint.types.ValidatorSet.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
      obj = {
        ...
        proposer:
          (f = msg.getProposer()) &&
          proto.tendermint.types.Validator.toObject(includeInstance, f),
...
proto.tendermint.types.ValidatorSet.deserializeBinary = function (bytes) {
  ...
  return proto.tendermint.types.ValidatorSet.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.tendermint.types.ValidatorSet}
 */
proto.tendermint.types.ValidatorSet.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.tendermint.types.Validator.deserializeBinaryFromReader,
        )
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tendermint.types.ValidatorSet.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 */
proto.tendermint.types.ValidatorSet.prototype.setValidatorsList = function (
  value,
) {
 ...
 */
proto.tendermint.types.ValidatorSet.prototype.addValidators = function (
  opt_value,
  opt_index,
) {
 ...
 * @return {!proto.tendermint.types.ValidatorSet} returns this
 */
proto.tendermint.types.ValidatorSet.prototype.clearValidatorsList =
  function () {
 ...
 * @return {number}
 */
proto.tendermint.types.ValidatorSet.prototype.getTotalVotingPower =
  function () {
 ...
 * @return {!proto.tendermint.types.ValidatorSet} returns this
 */
proto.tendermint.types.ValidatorSet.prototype.setTotalVotingPower = function (
  value,
) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.tendermint.types.Validator.prototype.toObject = function (
    opt_includeInstance,
  ) {
...
proto.tendermint.types.Validator.deserializeBinary = function (bytes) {
  ...
  return proto.tendermint.types.Validator.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.tendermint.types.Validator}
 */
proto.tendermint.types.Validator.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tendermint.types.Validator.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 * @return {!proto.tendermint.types.Validator} returns this
 */
proto.tendermint.types.Validator.prototype.setProposerPriority = function (
  value,
) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.tendermint.types.SimpleValidator.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.tendermint.types.SimpleValidator.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.tendermint.types.SimpleValidator.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.tendermint.types.SimpleValidator.deserializeBinary = function (bytes) {
  ...
  return proto.tendermint.types.SimpleValidator.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.tendermint.types.SimpleValidator}
 */
proto.tendermint.types.SimpleValidator.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tendermint.types.SimpleValidator.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 * @return {!proto.tendermint.types.SimpleValidator} returns this
 */
proto.tendermint.types.SimpleValidator.prototype.setVotingPower = function (
  value,
) {
