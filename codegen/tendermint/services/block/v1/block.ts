...
export namespace tendermint.services.block.v1 {
    ...
    export class GetByHeightResponse extends pb_1.Message {
        ...
        get block_id() {
            return pb_1.Message.getWrapperField(this, dependency_2.tendermint.types.BlockID, 1) as dependency_2.tendermint.types.BlockID;
        }
        ...
        get block() {
            return pb_1.Message.getWrapperField(this, dependency_1.tendermint.types.Block, 2) as dependency_1.tendermint.types.Block;
        }
