...
proto.tendermint.crypto.Proof = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.tendermint.crypto.Proof.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.tendermint.crypto.ValueOp.displayName =
    'proto.tendermint.crypto.ValueOp'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.tendermint.crypto.DominoOp.displayName =
    'proto.tendermint.crypto.DominoOp'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.tendermint.crypto.ProofOp.displayName =
    'proto.tendermint.crypto.ProofOp'
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.tendermint.crypto.ProofOps = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.tendermint.crypto.ProofOps.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.tendermint.crypto.ProofOps.displayName =
    'proto.tendermint.crypto.ProofOps'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.tendermint.crypto.Proof.prototype.toObject = function (
    opt_includeInstance,
  ) {
 ...
 * @return {!proto.tendermint.crypto.Proof}
 */
proto.tendermint.crypto.Proof.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tendermint.crypto.Proof.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
...
proto.tendermint.crypto.Proof.prototype.getLeafHash_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getLeafHash()))
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.tendermint.crypto.ValueOp.prototype.toObject = function (
    opt_includeInstance,
  ) {
  ...
  proto.tendermint.crypto.ValueOp.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        proof:
          (f = msg.getProof()) &&
          proto.tendermint.crypto.Proof.toObject(includeInstance, f),
      }
...
proto.tendermint.crypto.ValueOp.deserializeBinary = function (bytes) {
  ...
  return proto.tendermint.crypto.ValueOp.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.tendermint.crypto.ValueOp}
 */
proto.tendermint.crypto.ValueOp.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 2:
        ...
        reader.readMessage(
          value,
          proto.tendermint.crypto.Proof.deserializeBinaryFromReader,
        )
        msg.setProof(value)
        break
      default:
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tendermint.crypto.ValueOp.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.tendermint.crypto.DominoOp.prototype.toObject = function (
    opt_includeInstance,
  ) {
...
proto.tendermint.crypto.DominoOp.deserializeBinary = function (bytes) {
  ...
  return proto.tendermint.crypto.DominoOp.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.tendermint.crypto.DominoOp}
 */
proto.tendermint.crypto.DominoOp.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tendermint.crypto.DominoOp.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.tendermint.crypto.ProofOp.prototype.toObject = function (
    opt_includeInstance,
  ) {
...
proto.tendermint.crypto.ProofOp.deserializeBinary = function (bytes) {
  ...
  return proto.tendermint.crypto.ProofOp.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.tendermint.crypto.ProofOp}
 */
proto.tendermint.crypto.ProofOp.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tendermint.crypto.ProofOp.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.tendermint.crypto.ProofOps.prototype.toObject = function (
    opt_includeInstance,
  ) {
    ...
    var f,
      obj = {
        opsList: jspb.Message.toObjectList(
          msg.getOpsList(),
          proto.tendermint.crypto.ProofOp.toObject,
          includeInstance,
        ),
      }
...
proto.tendermint.crypto.ProofOps.deserializeBinary = function (bytes) {
  ...
  return proto.tendermint.crypto.ProofOps.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.tendermint.crypto.ProofOps}
 */
proto.tendermint.crypto.ProofOps.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.tendermint.crypto.ProofOp.deserializeBinaryFromReader,
        )
        msg.addOps(value)
        break
      default:
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tendermint.crypto.ProofOps.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 * @return {!proto.tendermint.crypto.ProofOp}
 */
proto.tendermint.crypto.ProofOps.prototype.addOps = function (
  opt_value,
  opt_index,
) {
