...
proto.tendermint.crypto.PublicKey = function (opt_data) {
  jspb.Message.initialize(
    ...
    -1,
    null,
    proto.tendermint.crypto.PublicKey.oneofGroups_,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.tendermint.crypto.PublicKey.displayName =
    'proto.tendermint.crypto.PublicKey'
}
...
proto.tendermint.crypto.PublicKey.prototype.getSumCase = function () {
  return /** @type {proto.tendermint.crypto.PublicKey.SumCase} */ (
    jspb.Message.computeOneofCase(
      this,
      proto.tendermint.crypto.PublicKey.oneofGroups_[0],
    )
  )
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.tendermint.crypto.PublicKey.prototype.toObject = function (
    opt_includeInstance,
  ) {
...
proto.tendermint.crypto.PublicKey.deserializeBinary = function (bytes) {
  ...
  return proto.tendermint.crypto.PublicKey.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.tendermint.crypto.PublicKey}
 */
proto.tendermint.crypto.PublicKey.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tendermint.crypto.PublicKey.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
...
proto.tendermint.crypto.PublicKey.prototype.getEd25519_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getEd25519()))
}
...
proto.tendermint.crypto.PublicKey.prototype.getEd25519_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getEd25519()))
}
...
proto.tendermint.crypto.PublicKey.prototype.getSecp256k1_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getSecp256k1()))
}
