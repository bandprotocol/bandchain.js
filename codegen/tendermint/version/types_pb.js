...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.tendermint.version.Consensus.displayName =
    'proto.tendermint.version.Consensus'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.tendermint.version.App.prototype.toObject = function (
    opt_includeInstance,
  ) {
 ...
 * @return {!proto.tendermint.version.App}
 */
proto.tendermint.version.App.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tendermint.version.App.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.tendermint.version.Consensus.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.tendermint.version.Consensus.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.tendermint.version.Consensus.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.tendermint.version.Consensus.deserializeBinary = function (bytes) {
  ...
  return proto.tendermint.version.Consensus.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.tendermint.version.Consensus}
 */
proto.tendermint.version.Consensus.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tendermint.version.Consensus.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
