...
import * as dependency_1 from "./../types/block";
import * as dependency_2 from "./../types/types";
import * as pb_1 from "google-protobuf";
export namespace tendermint.blocksync {
    ...
    export class BlockResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            block?: dependency_1.tendermint.types.Block;
            ext_commit?: dependency_2.tendermint.types.ExtendedCommit;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get block() {
            return pb_1.Message.getWrapperField(this, dependency_1.tendermint.types.Block, 1) as dependency_1.tendermint.types.Block;
        }
        set block(value: dependency_1.tendermint.types.Block) {
        ...
        get ext_commit() {
            return pb_1.Message.getWrapperField(this, dependency_2.tendermint.types.ExtendedCommit, 2) as dependency_2.tendermint.types.ExtendedCommit;
        }
        set ext_commit(value: dependency_2.tendermint.types.ExtendedCommit) {
        ...
        static fromObject(data: {
            block?: ReturnType<typeof dependency_1.tendermint.types.Block.prototype.toObject>;
            ext_commit?: ReturnType<typeof dependency_2.tendermint.types.ExtendedCommit.prototype.toObject>;
        }): BlockResponse {
            const message = new BlockResponse({});
            if (data.block != null) {
                message.block = dependency_1.tendermint.types.Block.fromObject(data.block);
            }
            if (data.ext_commit != null) {
                message.ext_commit = dependency_2.tendermint.types.ExtendedCommit.fromObject(data.ext_commit);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): BlockResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.block, () => message.block = dependency_1.tendermint.types.Block.deserialize(reader));
                        break;
                    case 2:
                        reader.readMessage(message.ext_commit, () => message.ext_commit = dependency_2.tendermint.types.ExtendedCommit.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
