...
proto.tendermint.libs.bits.BitArray = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.tendermint.libs.bits.BitArray.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.tendermint.libs.bits.BitArray.displayName =
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.tendermint.libs.bits.BitArray.prototype.toObject = function (
    opt_includeInstance,
  ) {
    return proto.tendermint.libs.bits.BitArray.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   */
  proto.tendermint.libs.bits.BitArray.toObject = function (
    includeInstance,
    msg,
  ) {
    var f,
...
proto.tendermint.libs.bits.BitArray.deserializeBinary = function (bytes) {
  ...
  return proto.tendermint.libs.bits.BitArray.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.tendermint.libs.bits.BitArray}
 */
proto.tendermint.libs.bits.BitArray.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tendermint.libs.bits.BitArray.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined
 ...
 * @return {!proto.tendermint.libs.bits.BitArray} returns this
 */
proto.tendermint.libs.bits.BitArray.prototype.addElems = function (
  value,
  opt_index,
) {
