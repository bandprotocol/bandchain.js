...
export const Signing = {
  ...
  encode(message: Signing, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.originator.length !== 0) {
      writer.uint32(42).bytes(message.originator);
    }
    if (message.message.length !== 0) {
      writer.uint32(50).bytes(message.message);
    }
    if (message.groupPubNonce.length !== 0) {
      writer.uint32(58).bytes(message.groupPubNonce);
    }
    ...
    if (message.createdHeight !== BigInt(0)) {
      writer.uint32(80).uint64(message.createdHeight);
    }
    if (message.createdTimestamp !== undefined) {
      Timestamp.encode(toTimestamp(message.createdTimestamp), writer.uint32(90).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.originator = reader.bytes();
          break;
        case 6:
  ...
  fromPartial(object: Partial<Signing>): Signing {
    ...
    message.originator = object.originator ?? new Uint8Array();
  ...
  fromAmino(object: SigningAmino): Signing {
    ...
    if (object.originator !== undefined && object.originator !== null) {
      message.originator = bytesFromBase64(object.originator);
    }
  ...
  toAmino(message: Signing): SigningAmino {
    ...
    obj.originator = message.originator ? base64FromBytes(message.originator) : undefined;
