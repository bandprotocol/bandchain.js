...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/band.restake.v1beta1.MsgStake", MsgStake], ["/band.restake.v1beta1.MsgUnstake", MsgUnstake], ["/band.restake.v1beta1.MsgUpdateParams", MsgUpdateParams]];
