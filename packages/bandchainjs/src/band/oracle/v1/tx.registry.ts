...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/band.oracle.v1.MsgRequestData", MsgRequestData], ["/band.oracle.v1.MsgReportData", MsgReportData], ["/band.oracle.v1.MsgCreateDataSource", MsgCreateDataSource], ["/band.oracle.v1.MsgEditDataSource", MsgEditDataSource], ["/band.oracle.v1.MsgCreateOracleScript", MsgCreateOracleScript], ["/band.oracle.v1.MsgEditOracleScript", MsgEditOracleScript], ["/band.oracle.v1.MsgActivate", MsgActivate], ["/band.oracle.v1.MsgUpdateParams", MsgUpdateParams]];
