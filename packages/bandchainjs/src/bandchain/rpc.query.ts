...
export const createRPCQueryClient = async ({
  ...
  return {
    bandchain: {
      v1: {
        node: (await import("./v1/node/query.rpc.Service")).createRpcQueryExtension(client),
        oracle: (await import("./v1/oracle/proof.rpc.Service")).createRpcQueryExtension(client)
      }
    },
    cosmos: {
      auth: {
